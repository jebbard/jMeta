...
public class Flags1ByteXXXTest extends FlagsTest {
   ...
   /**
    * @see com.github.jmeta.library.dataformats.api.FlagsTest#getBigEndianFlagSpecification()
    */
   @Override
   ...
   /**
    * @see com.github.jmeta.library.dataformats.api.FlagsTest#getLittleEndianFlagSpecification()
    */
   @Override
   ...
   protected List<FlagDescription> getFlagDescriptions() {
      if (m_flagDescriptions == null) {
         ...
         m_flagDescriptions.add(new FlagDescription(HAS_FOOTER_FLAG, new BitAddress(0, 1), "", 1, null));
         m_flagDescriptions.add(new FlagDescription(RESERVED_FLAG, new BitAddress(0, 2), "", 1, null));
         m_flagDescriptions.add(new FlagDescription(UNSYNCHRONISATION_FLAG, new BitAddress(0, 5), "", 1, null));
         m_flagDescriptions.add(new FlagDescription(HAS_PADDING_FLAG, new BitAddress(0, 7), "", 1, null));
      }
