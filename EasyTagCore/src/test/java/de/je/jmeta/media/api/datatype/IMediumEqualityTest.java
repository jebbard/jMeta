...
public class IMediumEqualityTest extends AbstractEqualsTest<IMedium<?>> {
   ...
   private List<IMedium<?>> createMedia() {
      ...
      media.add(DummyMediumCreator.createDummyInMemoryMedium(BYTE_ARRAY_4,
         "Hallo4", true));
      media.add(DummyMediumCreator.createDummyInMemoryMedium(BYTE_ARRAY_3,
         "Hallo3", false));
      media.add(DummyMediumCreator.createDummyInMemoryMedium(BYTE_ARRAY_2,
         "Hallo2", true));
      media.add(DummyMediumCreator.createDummyInMemoryMedium(BYTE_ARRAY_1,
         "Hallo1", false));
      media
         .add(new InputStreamMedium(CENTRAL_BYTE_ARRAY_INPUT_STREAM, "Hallo"));
   ...
   private List<IMedium<?>> createEqualMedia() {
      ...
      media.add(DummyMediumCreator.createDummyInMemoryMedium(BYTE_ARRAY_1,
         "Hallo1", false));
      media
         .add(new InputStreamMedium(CENTRAL_BYTE_ARRAY_INPUT_STREAM, "Tschau"));
      ...
      // to the same file
      media.add(DummyMediumCreator.createDummyFileMedium(new File("."), true));
