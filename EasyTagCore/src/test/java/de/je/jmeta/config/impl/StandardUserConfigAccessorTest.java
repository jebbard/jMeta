...
public class StandardUserConfigAccessorTest extends IUserConfigAccessorTest {
   ...
   protected List<InputStream> getUserConfigStreams() {
      ...
      if (m_userConfigStreams == null) {
         ...
         m_userConfigStreams.add(getClass().getResourceAsStream("userConfig1.properties"));
         m_userConfigStreams.add(getClass().getResourceAsStream("userConfig2.properties"));
         m_userConfigStreams.add(getClass().getResourceAsStream("userConfig3.properties"));
      }
