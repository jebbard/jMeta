...
public class StandardMediumReference implements IMediumReference {
   ...
   /**
    * @see de.je.jmeta.media.api.IMediumReference#advance(long)
    */
   @Override
   ...
   /**
    * @see de.je.jmeta.media.api.IMediumReference#before(de.je.jmeta.media.api.IMediumReference)
    */
   @Override
   ...
   /**
    * @see de.je.jmeta.media.api.IMediumReference#behindOrEqual(de.je.jmeta.media.api.IMediumReference)
    */
   @Override
   ...
   /**
    * @see de.je.jmeta.media.api.IMediumReference#distanceTo(de.je.jmeta.media.api.IMediumReference)
    */
   @Override
   ...
   /**
    * @see de.je.jmeta.media.api.IMediumReference#getAbsoluteMediumOffset()
    */
   @Override
   ...
   /**
    * @see de.je.jmeta.media.api.IMediumReference#getMedium()
    */
   @Override
