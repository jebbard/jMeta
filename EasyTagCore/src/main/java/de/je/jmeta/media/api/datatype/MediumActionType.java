...
public enum MediumActionType {
   ...
   WRITE,
   /**
    * The {@link MediumAction} is a truncate action on the external medium starting at a given offset (= shortening of
    * the medium). The size of the truncation is already completely defined by its offset, as it always reaches until
    * the end of file.
    */
   TRUNCATE
}
