...
Zu beachtende Punkte:
 - [X] Scope und Features der ersten veröffentlichten Version festlegen:
   - [X] Lesen und Schreiben?
   - [X] Welche Formate werden von v1.0 unterstützt?
   - [X] Strukturierte Textformate (XML): Ja oder nein?
   - [X] Streaming: Ja oder Nein?
   - [X] Nur Grund-library oder format-spezifische?
   - [X] Fehlertoleranz?
   - [X] Lesen großer Datenblöcke
 - [X] Grundlegende Architekturentscheidungen:
   - [X] Caching: Ja oder nein
   - [X] Nur binärer Datablock-Parser? Aufteilung in binär vs. Text?
   - [X] Überlebt Component Registry?
   - [X] Überlebt Plugin-Framework?
   - [X] Überlebt eigenes Logging und eigene Konfiguration?
 - [X] Endgültigen Namen festlegen: jMeta
...
**** DONE Namensgebung:
 ...
 - jMeta ist zu generisch? Außerdem ist der Name auch schon durch eine andersartige Library vergeben...
...
--> Endgültiger Name ist jMeta!

**** DONE Unterstützte Formate fest definieren
     :LOGBOOK:  
     - State "DONE"       from "IN PROGRESS" [2016-03-15 Di 19:00]
     :END:      

**** DONE Prüfung und Dokumentation: SimpleComponentRegistry?
      :LOGBOOK:  
...
**** DONE Bewertung Media: Aktueller Stand, Caching und Planung
  ...
  - [X] Discard: Was kann man wie löschen?
  - [ ] Interne Datenstrukturen für das Caching
  - [ ] Interne Datenstrukturen für MEdium References
  - [ ] Interne Datenstrukturen für das zweistufige Schreiben
...
**** DONE Warnungen im WKS größtenteils beseitigen
...
**** DONE Prüfung und Dokumentation: slf4j löst Logging ab?
     DEADLINE: <2016-04-10 So>
     :LOGBOOK:  
     - State "DONE"       from "IN PROGRESS" [2016-06-18 Sa 13:29]
     :END:      
**** DONE Prüfung und Dokumentation: Alternative Konfiguration statt Config-Komponente?
     :LOGBOOK:  
...
**** IN PROGRESS Prüfung und Dokumentation: Was sind die wirklichen Detailanforderungen und notwendigen Anpassungen an ExtensionManagement?
     :CLOCK:    
...
Noch offen:
 - [X] Abschnitt "Übergreifende Aspekte"
 - [X] Abschnitt "Scope"
...
**** DONE Paper für Flush-Algorithmus
     :CLOCK:    
...
Relative Links von übergeordneter Site funzen nicht:
...
*** TODO Build-Number für property project.build.buildNumber generieren

z.B: über Jenkins und in Maven-Build reingeben, oder über das Maven Build Number Plugin
*** DONE Alle Unittests auf Linux (Ubuntu 16.04) erfolgreich ausführen
    :CLOCK:    
...
*** DONE Umstieg auf UTF-8 für alle Source-Files!
    :CLOCK:    
    ...
    :END:      
*** DONE SonarLint,jdepend und findbugs (bzw. Ähnliches) in Build einbinden
    :CLOCK:    
...
*** CANCELED Analyse und Planung der Klassifizierung als Integrationstests und Unittests
    ...
    :Effort:   8:00
    :END:
*** CANCELED Einführung Integrationstests mit Maven
    :LOGBOOK:  
...
Nächste Schritte:
 ...
 - [X] Reste von BasicUtility zurück nach javaUtils
 - [X] Maven POMs und Dependencies aufäumen
...
Package-Namen, Klassenzugehörigkeit zu Utility
...
*** DONE Nutzung von Emacs für Tex-Doku
     :LOGBOOK:  
     - State "DONE"       from "IN PROGRESS" [2015-12-20 So 10:16]
...
*** DONE Bessere Precondition-Check API
    ...
    :END:      
*** DONE Abhängigkeitsstruktur der Maven-Projekte sauber ziehen
...
Ein Parent-POM, von dem alle Utility-Projekte ableiten, und eines für alle EasyTag-Projekte
** Komponente "Media"

*** Schätzung

Ursprüngliche Summe der Erstschätzung: 170 h

| Themengebiet              | Aktivität                                                              | Status | Implementierte               | Aufwand |   Tats. | Begründung Abweichung |
|                           | <70>                                                                   |        | Designentscheidungen         |  gesch. | Aufwand | <20>                 |
|                           |                                                                        |        |                              |     (h) |     (h) |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| Hilfskomponenten          | Design Configuration Helper                                            | DONE   | 089                          |       2 |       4 |                      |
|                           | Implementierung und Test Configuration Helper                          | DONE   | 089                          |       4 |    13.5 | Mehr Features als ursprünglich gedacht |
|                           | javadocs                                                               | DONE   |                              |       1 |       2 |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| IMedium                   | Überprüfung und ggf. Anpassung inkl. Tests                             | DONE   | 025-028, 051, 052, 053       |    0.25 |    0.25 |                      |
|                           | Konfiguration über IMedium ermöglichen                                 | DONE   | 091                          |    0.25 |    1.75 | Maven-Abhängigkeit fehlte, LongConfigParam fehlte, Tests aufwändiger zu schreiben als gedacht |
|                           | Anpassung javadocs                                                     | DONE   |                              |     0.5 |     0.5 |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| MediumReference           | Überprüfung und ggf. Anpassung, inkl. Tests                            | DONE   | 054-057                      |    0.25 |    0.25 |                      |
|                           | Setter für Ändern der Position                                         | DONE   |                              |    0.25 |       0 |                      |
|                           | Anpassung javadocs                                                     | DONE   |                              |     0.5 |       0 |                      |
|                           | Ensure advance and calculateEndReference can be used with Factory      | DONE   |                              |       4 |     0.5 |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| MediumRegion              | Umbenennen, EndReference durch size ersetzen, alle Tests bleiben lauffähig | DONE   | 076                          |     0.5 |    0.25 |                      |
...
|                           | Änderungen an updateReferences (DES 073) wegen Änderungen an replace   | DONE   |                              |       4 |    1.25 |                      |
...
|                           | Implementierung scheduleRemove inkl. Tests                             | DONE   | 062, 065, 066, 084           |       2 |    8.25 | Aufwände und Komplexität vollkommen unterschätzt, Lücken in Spezifikation |
...
|                           | Mehrere überlagerte MediumActions unterstützen                         | DONE   |                              |       4 |     0.5 |                      |
...
|                           | javadocs                                                               | DONE   |                              |       2 |       1 |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| IMediumAccessor           | Überprüfung aktueller Stand und ggf. Anpassung, inkl. Tests            | DONE   | 071                          |       2 |       1 |                      |
|                           | Implementierung isOpened inkl. Tests                                   | DONE   |                              |     0.5 |       0 |                      |
|                           | Prüfen und Refactoring aktueller Testcases                             | DONE   |                              |       6 |    5.75 |                      |
...
|                           | Locking überprüfen und ggf. anpassen                                   | DONE   | 029-031                      |       3 |       0 |                      |
|                           | Refactoring existierender Code                                         | DONE   |                              |       4 |     3.5 |                      |
|                           | Anpassung javadocs                                                     | DONE   |                              |       2 |       0 |                      |
|                           | Refactoring Timeout Tests                                              | DONE   |                              |       4 |    0.75 |                      |
|                           | Evaluierung alternative Varianten für timeout                          | DONE   |                              |       3 |         |                      |
|                           | Überprüfung, ggf. Anpassung und Test der Timeouts bei InputStreams     | DONE   | 050, 091                     |       4 |         |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| IMediumStore              | Basisimplementierung Gerüst des Interfaces                             | DONE   | 032, 033, 039, 068           |     0.5 |       0 |                      |
|                           | Explizites Dokumentieren der Performance-Nachteile von lesenden Byte-Streams | DONE   | 042                          |     0.5 |       0 |                      |
|                           | Überprüfung discard inkl. Anpassung der Tests                          | DONE   | 040, 048                     |       3 |       0 |                      |
...
|                           | Überprüfung isAtEndOfMedium inkl. Anpassung der Tests                  | DONE   | 068                          |     0.5 |    1.25 |                      |
...
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| IMediaAPI                 | Überprüfung aktueller Stand und ggf. Anpassung, inkl. Tests            | DONE   | 069                          |       1 |       0 |                      |
|                           | Implementierung createMediumStore inkl. Tests                          | DONE   | 069, 070                     |       2 |       0 |                      |
|                           | Anpassung javadocs                                                     | DONE   |                              |     0.5 |       0 |                      |
|---------------------------+------------------------------------------------------------------------+--------+------------------------------+---------+---------+----------------------|
| Anpassungen Caching       | Prüfung: Effizienteres split - nur referenz statt kopieren             | DONE   |                              |     0.5 |     0.5 |                      |
|                           | MediumAccessor erzeugt selbst ByteBuffer                               | DONE   |                              |       1 |    1.75 |                      |
|                           | Umbau InMemoryMediumAccessor komplett auf ByteBuffer                   | DONE   |                              |       1 |    2.25 |                      |
|                           | Minimale/Standard Cache-Größe einbauen                                 | DONE   |                              |     0.5 |       0 |                      |
|                           | Is Cached: Deaktivierbarkeit entfernen + Inmemory auch immer Cached    | DONE   |                              |       2 |    1.25 |                      |
|                           | Is Cached: Testfälle ausdünnen                                         | DONE   |                              |       2 |     0.5 |                      |
...
***** DONE Überprüfung und ggf. Anpassung inkl. Tests
      :CLOCK:    
...
***** DONE Konfiguration über IMedium ermöglichen
      :CLOCK:    
...
***** DONE Setter für Ändern der Position
      :LOGBOOK:  
...
***** DONE Umbenennen, EndReference durch size ersetzen, alle Tests bleiben lauffähig
      :CLOCK:    
...
***** DONE Änderungen an updateReferences (DES 073) wegen Änderungen an replace
      :CLOCK:    
...
***** DONE javadocs
      ...
      :END:
***** DONE Mehrere überlagerte MediumActions unterstützen
      :CLOCK:    
...
***** DONE Überprüfung, ggf. Anpassung und Test der Timeouts bei InputStreams
      :CLOCK:    
...
***** DONE Prüfen und Refactoring aktueller Testcases                         
      :CLOCK:    
...
***** DONE Refactoring existierender Code
      ...
      :END:      
***** DONE Locking überprüfen und ggf. anpassen                               
      :LOGBOOK:  
...
***** DONE Refactoring Timeout Tests
      ...
      - State "TODO"       from ""           [2017-10-08 So 16:19]
      :END:      
***** DONE Evaluierung alternative Varianten für timeout                      
      :LOGBOOK:  
...
***** DONE Überprüfung isAtEndOfMedium inkl. Anpassung der Tests
      :CLOCK:    
...
***** DONE Prüfung: Effizienteres split - nur referenz statt kopieren
      :LOGBOOK:  
...
***** DONE Is Cached: Testfälle ausdünnen
      :CLOCK:    
...
1.) Vereinfachung Umgang mit generischen Containern und IDs
 ...
 - Prüfung: Generischer Datenblock muss mindestens ein generisches Pattern enthalten {$FRAME}
 - Dazu wird jedem konkreten Datenblock eine generische Basis-ID statisch zugeordnet (max. eine)
 - 

2.) String list field type nötig für ID3v24

3.) DataBlockDescriptionBuilder

5.) Felder: Sind nicht mehr generisch, speichern nicht mehr den "Interpreted Value", sondern bieten nur eine generische convert-Methode mit Übergabe des passenden FieldConverter<T>
...
|                      | ContainerDataFormat einführen                      | DONE      |                      |       1 |    0.25 |                 |
...
|                      | Prüfung min/max length/occurrences auf Plausi      | DONE      | 147, 148             |       1 |     0.5 |                 |
...
Implementierungstaktik:
 1. Neue Typen FIELD_BASED_PAYLOAD und CONTAINER_BASED_PAYLOAD in PhysicalBlockType einführen
 2. Neue Interfaces extends Payload einführen mit den jeweiligen Methoden
 3. LazyPayload durch Kopie in zwei deutlich schönere Klassen aufteilen
 ...
 8. Alle Tests ausführen und fixen
...
Schritte:
 1. [X] Lyrics3v2: Überschreiben der Implementierung, um Payload-Länge ohne "Exclusion Key" ermitteln zu können (hasContainerWithId überschreiben) - hasContainerWithId überschreiben
 2. [X] Default nested container einführen
 3. [X] Logik umbauen top-level: Wenn kein Container anhand Magic key gefunden, dann vermute die Präsenz des Default Containers
 4. [X] Magic Key Klassen aufräumen: Exclusion Keys wegschmeißen
 5. [X] ID3v1: Überschreiben der Parser-Impl für Rückwärts-Lesen + Rausnehmen von "Offset for Backward Reading"
 6. [X] TopLevelContainerIterator und TopLevelReverseContainerIterator vereinfachen und von gemeinsamer Basis ableiten
 7. [X] Magic Keys direkt von Feldern ableiten
 8. [X] Unknown Container analog Unknown Field nötig (?)
...
***** DONE Prüfung min/max length/occurrences auf Plausi
      :CLOCK:    
...
***** IN PROGRESS DataBlockDescriptionBuilder
 ...
 - [X] Prüfen: isGeneric als Feld in DataBlockDescription?
 - [X] Prüfen: Mergen von DataBlockDescription und FieldProperties?
 - [X] Prüfen: DataBlockDescription - Setter reinnehmen?
 - [X] TopLevel: createGeneric*Container umsetzen
 - [X] TopLevel* Interface rausziehen
 - [X] TopLevel* liefert direkt Ergebnis
 - [X] byte orders und charsets mit builder hinzufügen
 - [X] DescriptionCOllector: getAllDescriptions() rausnehmen, d.h. MagicKey-Sonderfall bei MP3 loswerden
 - [X] Plausi-Check: Exception werfen, wenn builder noch net fertig bestückt (finish nicht aufgerufen)
 - [X] Prüfen: Child descriptions direkt in DBDesc + getChildDescOf type als direkte Funktion?
 - [X] Validierung: Plausi von DataBlockDescriptions (Standalone)
 - [X] Clone umsetzen
 - [X] Nicht mehr lauffähigen Testfall wieder lauffähig machen
 ...
 - [X] Größen: Undefiniert
 - [X] InvalidSpecificationException überall einsetzen
 - [X] Vater-Größen von Kindern automatisch ableiten + Längenprüfung
...
**** Lesen
  ...
  |                 |                                                    |        |                      |     (h) |     (h) |                 |
  |-----------------+----------------------------------------------------+--------+----------------------+---------+---------+-----------------|
  | Vorwärts-Lesen  | Überprüfung Vorwärts-Lesen                         |        |                      |       6 |    3.25 |                 |
  |                 | Design Vorwärts-Lesen                              |        |                      |      12 |   20.25 |                 |
  |                 | Testfälle Streaming Media                          |        |                      |       4 |     3.5 |                 |
  |                 | Implementierungsanpassungen Vorwärts-Lesen         |        |                      |         |      44 |                 |
  |                 | Weitere Anpassungen (Design + Impl) nach Schreiben |        |                      |      16 |         |                 |
  |-----------------+----------------------------------------------------+--------+----------------------+---------+---------+-----------------|
  | Rückwärts-Lesen |                                                    |        |                      |       8 |     4.5 |                 |
  |-----------------+----------------------------------------------------+--------+----------------------+---------+---------+-----------------|
  |-----------------+----------------------------------------------------+--------+----------------------+---------+---------+-----------------|
  |                 |                                                    |        | SUMME                |      46 |     71. |                 |
  |-----------------+----------------------------------------------------+--------+----------------------+---------+---------+-----------------|
...
| Themengebiet         | Aktivität                                                              | Status    | Aufwand |   Tats. | Implementierte       | Begründung Abweichung |
...
|                      | DataBlockState einführen, auch in Factory                              | DONE      |     0.5 |    0.25 |                      |                      |
...
*** DONE Überprüfung Vorwärts-Lesen
    :CLOCK:    
...
Macht Caching in Media-Komponente jetzt insgesamt Sinn oder nicht?
 -> Geht so: Caching ist immer entweder aktiv (min. Cache-Größe > 0) oder es ist eh ein Byte-Array

Ziele:
 - Doku des Lese-Vorgehens
 - Lese-Vorgehen sinnvoll auf Media-Komponente abgestimmt
 - Komplexitätsverringerung, insb. Code-Vereinfachung und Verkürzung
 - Basis für schreibende Zugriffe legen

Vorgehen:
 - Code-Review inkl. Klassendiagramm
 - Ideen-Skizze nach Review überarbeiten
 - Basierend auf existierender Doku das Design-Konzept für das Vorwärts-Lesen basierend auf einfachen Designentscheidungen Schritt für Schritt aufbauen
 - Schätzung für Implementierungsanpassungen
 - Danach Design für Rückwärts-Lesen

Idee Vorwärts-Lesen:
 1. Bestimme Block-Typ:
    a. Maximale Header-Größe aus allen unterstützten Datenformaten lesen und entsprechend viele Bytes cachen
    b. Falls End-Of-Medium: Datenformat ausschließen
    c. Identifikation des Datenformats anhand Magic Key
 2. Nur Streaming-Media:
    a. Bei Aufruf von "next()": Fülle Payload-Bytes in den Cache durch expliziten Aufruf von "cache()": Tut nichts bei Byte-Array, bei Datei und Stream liest es bis zur maximalen Cache-Größe alles rein
 3. Lazy Payload:
    a. Nur bei Random-Access-Medien
    b. Daten werden erst gelesen, wenn zum ersten Mal auf die Inhalte zugegriffen wird über getData()
    c. Resultiert evtl. in einer InvalidMediumOffsetException falls keine Daten mehr vorhanden sind
 4. Lazy Field:
    a. Ab einer bestimmten Mindestgröße werden auch Felder mit bekannter Größe erst in den Speicher gelesen, wenn explizit angefragt
    b. Nur bei Random-Access-Medien?
 5. Felder lesen im Detail: TODO
 6. Offene Punkte:
    a. Feldkonvertierung wie?
    b. Brauch man den ganzen "Listener"-Scheiß noch?
    ...
    e. Eingriffs-/Konfigurationsmöglichkeiten Anwender?
    f. Eingriffs-/Konfigurationsmöglichkeiten Extension?

Rückwärts-Lesen?

*** DONE Design-Vorwärts-Lesen
    :LOGBOOK:
...
*** DONE Implementierungsanpassungen Vorwärts-Lesen
    :LOGBOOK:
    - State "DONE"       from "IN PROGRESS" [2019-03-26 Di 06:23]
    ...
    :END:
**** DONE FieldFunctionStack aufräumen
     :LOGBOOK:
...
Nächste Schritte:
  ...
  - [X] Ext header mit dyn. Länge
  - [X] ID_OF als FieldFunction ersetzen durch isId()
  - [X] Aufräumen und dokumentieren AbstractFieldFunction
  - [X] Aufräumen und dokumentieren ContainerContext
  - [X] Aufräumen und dokumentieren CustomCount/SizeProvide
  - [X] APE is optional fixen
  - [X] Verwendung von ByteOrders und Charsets überprüfenr
  - [X] AbstractChecksumOf einführen mit CRCOf als Subklasse; nutzen in MP3 und ID3v2.3 ext header
  - [X] Validieren von CustomSizeOf

*** DONE Testfälle Streaming Media
    :LOGBOOK:
...
*** DONE Design + Impl Rückwärts-Lesen
    :CLOCK:
...
Nächste Schritte:
 - [X] Statische Footer-Länge
 - [X] Statische Header-Länge
 - [X] Design-Doku
 - [X] Javadocs + Aufräumen
...
**** IN PROGRESS Vor-Restrukturierung
 ...
 - [X] DataBlockState einführen, auch in Factory         
...
*** IN PROGRESS Weitere Themen Vorwärts-Lesen
    :LOGBOOK:
...
Themen:
 ...
 - [ ] Feldkonvertierung
 - [ ] Umgang mit Parent Datenblöcken?
   - Kann man Parents eliminieren (aktuell braucht man die nicht wirklich)
 - [ ] Umgang mit generischen Blöcken?
   - Idee: Base id des generischen Blocks in dataBlockId bei Erzeugung speichern
   - Problem: Was macht man für einen völlig neuen und unbekannten Container-Block?
 - [ ] DataBlockReader-Subklassen eliminieren? -> ContainerReader Interface als Ersatz für das Ableiten von DataBlockReader, wird implementiert von ID3v1 und Lyrics3v2 sowie ID3v2.4 (für Rückwärtslesen - damit die Optionalität und dynamische Länge des extended header berücksichtigt werden kann)
...
|                         |                                                                        |        |                      |     (h) |     (h) |                      |
|-------------------------+------------------------------------------------------------------------+--------+----------------------+---------+---------+----------------------|
| Schätzung Logging       | Schätzung erstellen                                                    | DONE   |                      |     0.5 |    0.25 |                      |
|-------------------------+------------------------------------------------------------------------+--------+----------------------+---------+---------+----------------------|
| Design Logging          | Aktuelle Designentscheidungen prüfen                                   | DONE   |                      |     0.5 |       0 |                      |
...
***** DONE Aktuelle Designentscheidungen prüfen
      :CLOCK:    
