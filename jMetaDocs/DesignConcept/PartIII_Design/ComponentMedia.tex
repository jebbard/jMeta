...
\item Step 1: \emph{insert} at offset $x$, Step 2: \emph{remove} at same offset: Both calls are allowed, they do not influence each other.
\item Step 1: \emph{remove} at offset $x$, Step 2: \emph{insert} at same offset: Both calls are allowed, they do not influence each other.
...
\item Step 1: \emph{insert} at offset $x$, Step 2: \emph{replace} at same offset: Both calls are allowed, they do not influence each other.
\item Step 1: \emph{replace} at offset $x$, Step 2: \emph{insert} at same offset: Both calls are allowed, they do not influence each other.
...
\item[b.] Bytes behind: None, or whole-numbered multiple of the maximum write block size $m$, or no whole-numbered multiple of $m$, or fewer bytes than $m$
...
\item[b.] Bytes in-between/behind: None, whole-numbered multiple of the maximum write block size $m$, or no whole-numbered multiple of $m$, or fewer bytes than $m$
