...
{% Rationale
This is sufficient for e.g. handling the case of ID3v2.3 and all other cases mentioned during the discussion of \DesLink{dd:540}.
}
{% Disadvantes
No disadvantages known
}
