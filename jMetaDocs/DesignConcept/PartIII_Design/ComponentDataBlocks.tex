...
DD: Rückwärtslesen geht nur für Random Access medien
DD: Only static header and footer lengths allowed, thus currently excluding cases such as ID3v2.4 header + dynamic size ext header + footer for backward reading
DD: Backward readable formats must define footers with magic keys
DD: How to handle ID3v1 backward reading
