...
import com.github.jmeta.utility.config.impl.StandardUserConfigAccessorTest;
 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ StandardExtensionManagerTest.class, StandardUserConfigAccessorTest.class })
