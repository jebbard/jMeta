...
public class ByteArrayUtilsTest {
	...
	public void setUp() {
		...
		stringArraysCorrect.put("{-123,1,5, 10, -32, 5,}*9",
			new byte[] { -123, 1, 5, 10, -32, 5, -123, 1, 5, 10, -32, 5, -123, 1, 5, 10, -32, 5, -123, 1, 5, 10, -32, 5,
				-123, 1, 5, 10, -32, 5, -123, 1, 5, 10, -32, 5, -123, 1, 5, 10, -32, 5, -123, 1, 5, 10, -32, 5, -123, 1,
				5, 10, -32, 5, });
	...
	/**
	 * Test {@link ByteArrayUtils#findFirst(byte[], byte[], int, int)} with start
	 * offset.
	 */
	@Test
	...
	/**
	 * Test {@link ByteArrayUtils#findFirst(byte[], byte[], int, int)} w/o start
	 * offset.
	 */
	@Test
