...
/**
 * {@link NineColumnCsvFileTest} tests the {@link CsvReader} class with some typical nine column CSV file, with specific
 * separator and default quote, with some quoted columns that contain separators within the quote.
 *
...
public class NineColumnCsvFileTest extends AbstractCsvReaderTest {
   ...
   protected List<String[]> getExpectedDataInCorrectFile() {
      if (m_expectedDataCorrectFile == null) {
         ...
         m_expectedDataCorrectFile.add(new String[] { "HALLO_12", "\"a/b/c/d/e\"", "HALLO_32", "HALLO_42", "HALLO_52",
            "HALLO_62", "HALLO_72", "HALLO_82", "HALLO_92", });
         m_expectedDataCorrectFile.add(new String[] { "HALLO_11", "HALLO_21", "HALLO_31", "HALLO_41", "HALLO_51",
            "HALLO_61", "HALLO_71", "HALLO_81", "HALLO_91", });
         ...
         m_expectedDataCorrectFile.add(new String[] { "HALLO_11", "HALLO_21", "\"HALLO_31\"", "HALLO_41", "HALLO_51",
            "HALLO_61", "HALLO_71", "HALLO_81", "HALLO_91", });
         m_expectedDataCorrectFile.add(new String[] { "HALLO_11", "HALLO_21", "HALLO_31", "HALLO_41", "\"hallo mit /\"",
            "HALLO_61", "HALLO_71", "HALLO_81", "HALLO_91", });
      }
