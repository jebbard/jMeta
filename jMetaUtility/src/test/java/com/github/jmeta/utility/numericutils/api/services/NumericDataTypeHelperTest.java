...
/**
 * {@link NumericDataTypeHelperTest} tests the {@link NumericDataTypeUtil}
 * class.
 */
public class NumericDataTypeHelperTest {
	...
	public void test_signedValue_int() {
		long[] inputData = new long[] { 0, 1, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 1,
			NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 2, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 4, 50,
			NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 55, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 32768,
			32767, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 128 };
	...
	public void test_unsignedValue_int() {
		...
		long[] expectedData = new long[] { 0, 1, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 1,
			NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 2, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 4, 50,
			NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 55, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 32768,
			32767, NumericDataTypeHelperTest.MAX_UINT_PLUS_ONE - 128 };
