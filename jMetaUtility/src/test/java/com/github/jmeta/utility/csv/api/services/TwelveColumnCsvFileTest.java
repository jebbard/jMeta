...
/**
 * {@link TwelveColumnCsvFileTest} tests the {@link CsvReader} class with some
 * typical twelve column CSV file, with default separator and default quote,
 * without any data quoted.
 */
	...
	protected List<String[]> getExpectedDataInCorrectFile() {
		if (m_expectedDataCorrectFile == null) {
			...
			m_expectedDataCorrectFile.add(new String[] { "HALLO_1", "HALLO_2", "HALLO_3", "HALLO_4", "HALLO_5",
				"HALLO_6", "HALLO_7", "HALLO_8", "HALLO_9", "HALLO_10", "HALLO_11", "HALLO_12", });
