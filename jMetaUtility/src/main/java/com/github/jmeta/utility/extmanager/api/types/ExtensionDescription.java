...
/**
 * {@link ExtensionDescription} is just a set of additional descriptions of an
 * {@link Extension}. These values just have information purpose and are not
 * used in any functional way.
 */
public class ExtensionDescription {
	 ...
	 * @param authors         a string representing the author(s) of the extension
	 * @param version         a version string identifying the version of this
	 *                        extension
	 * @param publishTime     a time indicating when this extension was published
	 * @param description     a human-readable, preferably English description of
	 *                        this extension
	 * @param copyrightNotice a copyright notice for this extension
	 * @param licenseTerms    the license terms for this extension
	 */
