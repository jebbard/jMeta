...
/**
 * {@link JMetaIllegalStateException} is used to indicate unexpected states in
 * complex operations. It is thus semantically the same as a usual
 * {@link IllegalStateException}, but with additional logging support.
 */
