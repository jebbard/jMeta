...
/**
 * {@link JMetaRuntimeException} is the base class of all specific runtime
 * exceptions of the library. It adds simple logging support to each exception.
 */
public class JMetaRuntimeException extends RuntimeException {
	 ...
	 * @param cause   The causing exception or null
	 */
	 ...
	 * @param message    The exception message or null
	 * @param cause      The causing exception or null
	 * @param logMessage A log message deviating from the exception message
	 */
	public JMetaRuntimeException(String message, Throwable cause, String logMessage) {
		super(message, cause);

		if (JMetaRuntimeException.LOGGER.isErrorEnabled()) {
			JMetaRuntimeException.LOGGER.error(logMessage, this);
		}
	}
}
