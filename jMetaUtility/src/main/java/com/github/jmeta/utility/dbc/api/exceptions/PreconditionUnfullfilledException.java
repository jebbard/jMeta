...
/**
 * {@link PreconditionUnfullfilledException} is thrown whenever a specified
 * prerequisite-condition of a class is violated.
 */
public class PreconditionUnfullfilledException extends JMetaRuntimeException {
	 ...
	 * 
	 * @param message The message containing the cause of this exception.
	 */
