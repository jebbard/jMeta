...
/**
 * {@link NamedReader} class is a {@link BufferedReader} that adds some meta
 * data to a given arbitrary, wrapped {@link Reader}. This is mainly useful for
 * identification purposes, because you sometimes want to know the original
 * source of a given {@link Reader} (file, URL etc.).
 */
public class NamedReader extends BufferedReader {

	/**
	 * Creates a new {@link NamedReader} instance using a given existing file. The
	 * wrapped {@link Reader} is created as a {@link InputStreamReader} with the
	 * given charset.
	 * 
	 * @param file    The given {@link File}. Must exist and be a file.
	 * @param charset The {@link Charset} to use.
	 * @return The {@link NamedReader}.
	 * @throws IOException if creation of the wrapped {@link Reader} fails.
	 */
	...
	/**
	 * Creates a new {@link NamedReader} instance using a given resource. It creates
	 * a new wrapped {@link Reader} using the
	 ...
	 * 
	 * @param in   The wrapped {@link Reader}.
	 * @param name Name of the wrapped {@link Reader}, arbitrary, but non-null.
