...
/**
 * {@link OggDummyDataFormatExtension}
 *
 */
public class OggDummyDataFormatExtension implements IDataFormatsExtension {

   @Override
   public DataFormat getDataFormat() {

      return DefaultExtensionsDataFormat.OGG;
   }

   private static final String OGG_MAGIC_KEY_STRING = "OggS";

   private static final byte[] OGG_MAGIC_KEY_BYTES = new byte[] { 'O', 'g', 'g',
      'S' };
   ...
   public IDataFormatSpecification getSpecification() {
      ...
      // Data blocks
      final DataBlockId oggPageId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg");
      final DataBlockId oggPageHeaderId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header");
      final DataBlockId oggPayloadId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.payload");

      final DataBlockId oggPageHeaderCaptureId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.capturePattern");
      final DataBlockId oggPageHeaderStreamStructVersionId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.streamStructureVersion");
      final DataBlockId oggPageHeaderHeaderTypeFlagId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.headerTypeFlag");
      final DataBlockId oggPageHeaderAbsoluteGranulePosId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.absoluteGranulePos");
      final DataBlockId oggPageHeaderStreamSerialNoId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.streamSerialNumber");
      final DataBlockId oggPageHeaderPageSequNoId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.pageSequenceNumber");
      final DataBlockId oggPageHeaderPageChecksumId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.pageChecksum");
      final DataBlockId oggPageHeaderSegmentsId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.pageSegments");
      final DataBlockId oggPageHeaderSegmentTableEntryId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.header.segmentTableEntry");

      final DataBlockId oggPacketPartContainerId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG, "ogg.payload.packetPartContainer");
      final DataBlockId oggPacketPartId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG,
         "ogg.payload.packetPartContainer.payload");
      final DataBlockId oggSegmentId = new DataBlockId(
         DefaultExtensionsDataFormat.OGG,
      ...
      descMap.put(oggPageHeaderCaptureId,
         new DataBlockDescription(oggPageHeaderCaptureId,
            "Ogg page header capture pattern",
            "Ogg page header capture pattern", PhysicalDataBlockType.FIELD,
            capturePatternChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.STRING, OGG_MAGIC_KEY_STRING, null,
      ...
      descMap.put(oggPageHeaderStreamStructVersionId,
         new DataBlockDescription(oggPageHeaderStreamStructVersionId,
            "Ogg page header stream structure version",
            "Ogg page header structure version", PhysicalDataBlockType.FIELD,
            streamStructVersionChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.BINARY,
               new BinaryValue(new byte[] { 0 }), null, null, 1, 1, null, null,
      ...
      descMap.put(oggPageHeaderHeaderTypeFlagId,
         new DataBlockDescription(oggPageHeaderHeaderTypeFlagId,
            "Ogg page header type flag", "Ogg page header type flag",
            PhysicalDataBlockType.FIELD, headerTypeFlagChildIds,
      ...
      streamSerialNoLocationProps.put(oggPageHeaderId,
         new LocationProperties(14, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      final List<DataBlockId> streamSerialNoChildIds = new ArrayList<>();

      descMap.put(oggPageHeaderStreamSerialNoId, new DataBlockDescription(
         oggPageHeaderStreamSerialNoId, "Ogg page stream serial number",
         "Ogg page stream serial number", PhysicalDataBlockType.FIELD,
         streamSerialNoChildIds, ChildOrder.SEQUENTIAL,
      ...
      pageSequNoLocationProps.put(oggPageHeaderId,
         new LocationProperties(18, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      final List<DataBlockId> pageSequNoChildIds = new ArrayList<>();

      descMap.put(oggPageHeaderPageSequNoId, new DataBlockDescription(
         oggPageHeaderPageSequNoId, "Ogg page sequence number",
         "Ogg page sequence number", PhysicalDataBlockType.FIELD,
         pageSequNoChildIds, ChildOrder.SEQUENTIAL,
         new FieldProperties<Long>(FieldType.UNSIGNED_WHOLE_NUMBER, null, null,
            null, 4, 4, null, null, null, null, null, null, null, null),
      ...
      pageChecksumLocationProps.put(oggPageHeaderId,
         new LocationProperties(22, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      final List<DataBlockId> pageChecksumChildIds = new ArrayList<>();

      descMap.put(oggPageHeaderPageChecksumId,
         new DataBlockDescription(oggPageHeaderPageChecksumId,
            "Ogg page checksum", "Ogg page checksum",
            PhysicalDataBlockType.FIELD, pageChecksumChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<BinaryValue>(FieldType.BINARY, null, null, null,
      ...
      pageSegmentsLocationProps.put(oggPageHeaderId,
         new LocationProperties(26, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      pageSegmentsFunctions.add(new FieldFunction(FieldFunctionType.COUNT_OF,
         affectedBlocks, null, 0));

      final List<DataBlockId> pageSegmentsChildIds = new ArrayList<>();

      descMap.put(oggPageHeaderSegmentsId,
         new DataBlockDescription(oggPageHeaderSegmentsId, "Ogg page segments",
            "Ogg page segments", PhysicalDataBlockType.FIELD,
            pageSegmentsChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<Long>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, 1, 1, null, null, null, null, null, null, null,
               pageSegmentsFunctions),
      ...
      segmentTableLocationProps.put(oggPageHeaderId,
         new LocationProperties(26, 0, 99999, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      segmentTableEntryFunctions.add(new FieldFunction(
         FieldFunctionType.SIZE_OF, affectedBlocks2, null, 0));

      final List<DataBlockId> segmentTableChildIds = new ArrayList<>();

      descMap.put(oggPageHeaderSegmentTableEntryId,
         new DataBlockDescription(oggPageHeaderSegmentTableEntryId,
            "Ogg page segment table entry", "Ogg segment table entry",
            PhysicalDataBlockType.FIELD, segmentTableChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<Long>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, 1, 1, null, null, null, null, null, null, null,
               segmentTableEntryFunctions),
      ...
      descMap.put(oggPageHeaderId,
         new DataBlockDescription(oggPageHeaderId, "Ogg page header",
            "Ogg page header", PhysicalDataBlockType.HEADER, pageHeaderChildIds,
            ChildOrder.SEQUENTIAL, null, pageHeaderLocationProps,
      ...
      packetContainerLocationProps.put(oggPayloadId,
         new LocationProperties(0, 1, 999999, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      descMap.put(oggPacketPartContainerId,
         new DataBlockDescription(oggPacketPartContainerId, "Ogg packet",
            "Ogg packet", PhysicalDataBlockType.CONTAINER,
            packetContainerChildIds, ChildOrder.SEQUENTIAL, null,
            packetContainerLocationProps, 1, DataBlockDescription.UNKNOWN_SIZE,
            null, null));
      ...
      descMap.put(oggPacketPartId,
         new DataBlockDescription(oggPacketPartId, "Ogg packet", "Ogg packet",
            PhysicalDataBlockType.PAYLOAD, packetChildIds,
            ChildOrder.SEQUENTIAL, null, packetLocationProps, 1,
            DataBlockDescription.UNKNOWN_SIZE, null, null));
      ...
      descMap.put(oggSegmentId,
         new DataBlockDescription(oggSegmentId, "Ogg segment", "Ogg segment",
            PhysicalDataBlockType.FIELD, segmentChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<BinaryValue>(FieldType.BINARY, null, null, null,
               DataBlockDescription.UNKNOWN_SIZE,
      ...
      descMap.put(oggPayloadId,
         new DataBlockDescription(oggPayloadId, "Ogg page payload",
            "Ogg page payload", PhysicalDataBlockType.PAYLOAD,
            pagePayloadChildIds, ChildOrder.SEQUENTIAL, null,
      ...
      pageLocationProps.put(null,
         new LocationProperties(DataBlockDescription.UNKNOWN_SIZE, 1, 1,
            DataBlockDescription.UNKNOWN_SIZE, new ArrayList<>(),
            new ArrayList<>()));

      // Magic Keys
      MagicKey oggMagicKey = new MagicKey(OGG_MAGIC_KEY_BYTES,
         OGG_MAGIC_KEY_BYTES.length * Byte.SIZE, OGG_MAGIC_KEY_STRING,
         oggPageHeaderId, MagicKey.NO_BACKWARD_READING, 0);

      List<MagicKey> oggMagicKeys = new ArrayList<>();
      oggMagicKeys.add(oggMagicKey);

      descMap.put(oggPageId,
         new DataBlockDescription(oggPageId, "Ogg page", "The ogg page",
            PhysicalDataBlockType.CONTAINER, pageChildIds,
            ChildOrder.SEQUENTIAL, null, pageLocationProps,
            DataBlockDescription.UNKNOWN_SIZE,
      ...
      IDataFormatSpecification dummyOggSpec = new StandardDataFormatSpecification(
         DefaultExtensionsDataFormat.OGG, descMap, topLevelIds,
   ...
   public String getExtensionId() {
      ...
      return "DEFAULT_de.je.jmeta.defext.dataformats.impl.OGGDummyDataFormatExtension";
   }
}
