/**
 *
 * {@link ID3v23DummyDataFormatExtension}.java
 *
 * @author Jens Ebert
 *
 * @date 05.01.2011
...
package de.je.jmeta.defext.dataformats.impl;
...
// TODO: id3v2: SIZE_OF tag payload INCLUDES size of extended header! This must be
// tested to work correctly

/**
 * {@link ID3v23DummyDataFormatExtension}
 *
 */
public class ID3v23DummyDataFormatExtension implements IDataFormatsExtension {
   ...
   private static final String ID3V23_TAG_MAGIC_KEY_STRING = ID3V23_TAG_ID_STRING
      + ID3V23_TAG_VERSION_STRING;

   private static final byte[] ID3V23_TAG_ID_BYTES = new byte[] { 'I', 'D',
      '3' };
   ...
   static {
      ...
      for (int i = 0; i < ID3V23_TAG_VERSION_BYTES.length; i++) {
         ID3V23_TAG_MAGIC_KEY_BYTES[ID3V23_TAG_ID_BYTES.length
            + i] = ID3V23_TAG_VERSION_BYTES[i];
      }
   }

   private static final DataBlockId ID3V23_HEADER_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.header");

   private static final DataBlockId ID3V23_PAYLOAD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.payload");

   private static final DataBlockId ID3V23_TAG_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23");
   ...
   private static final DataBlockId ID3V23_EXTENDED_HEADER_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.extHeader");

   private static final DataBlockId ID3V23_HEADER_ID_FIELD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.header.id");

   private static final DataBlockId ID3V23_HEADER_VERSION_FIELD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.header.version");

   private static final DataBlockId ID3V23_HEADER_FLAGS_FIELD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.header.flags");

   private static final DataBlockId ID3V23_HEADER_SIZE_FIELD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.header.size");
   ...
   private static final DataBlockId GENERIC_FRAME_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, ID3V23_GENERIC_CONTAINER_ID);
   ...
   private static final DataBlockId GENERIC_FRAME_PAYLOAD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23,
   ...
   private static final DataBlockId GENERIC_FRAME_HEADER_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23,
   ...
   private static final DataBlockId GENERIC_INFORMATION_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23,
      ID3V23_GENERIC_CONTAINER_ID + ".payload.information");

   private static final DataBlockId GENERIC_TEXT_ENCODING_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23,
      ID3V23_GENERIC_CONTAINER_ID + ".payload.textEncoding");

   private static final DataBlockId PADDING_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.payload.padding");

   private static final DataBlockId PADDING_PAYLOAD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23, "id3v23.payload.padding.payload");

   private static final DataBlockId PADDING_BYTES_FIELD_ID = new DataBlockId(
      DefaultExtensionsDataFormat.ID3v23,
      "id3v23.payload.padding.payload.bytes");

   /**
    * @see de.je.jmeta.dataformats.export.IDataFormatsExtension#getDataFormat()
    */
   @Override
   public DataFormat getDataFormat() {

      return DefaultExtensionsDataFormat.ID3v23;
   }

   /**
    * @see de.je.jmeta.dataformats.export.IDataFormatsExtension#getSpecification()
    */
   @Override
   ...
   private void addTag(Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      // Magic Keys
      MagicKey id3v23MagicKey = new MagicKey(ID3V23_TAG_MAGIC_KEY_BYTES,
         ID3V23_TAG_MAGIC_KEY_BYTES.length * Byte.SIZE,
         ID3V23_TAG_MAGIC_KEY_STRING, ID3V23_HEADER_ID,
      ...
      descMap.put(ID3V23_TAG_ID,
         new DataBlockDescription(ID3V23_TAG_ID, "id3v23 tag", "The id3v23 tag",
            PhysicalDataBlockType.CONTAINER, tagChildIds, ChildOrder.SEQUENTIAL,
            null, null, 21, DataBlockDescription.UNKNOWN_SIZE,
            id3v23TagMagicKeys, null));
   }
   ...
   private void addPayload(Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      payloadLocationProps.put(ID3V23_TAG_ID,
         new LocationProperties(10, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      descMap.put(ID3V23_PAYLOAD_ID,
         new DataBlockDescription(ID3V23_PAYLOAD_ID, "payload",
            "The id3v23 payload", PhysicalDataBlockType.PAYLOAD,
            payloadChildIds, ChildOrder.UNORDERED, null, payloadLocationProps,
    ...
    * @param descMap
    */
   private void addPayloadFrames(
      Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      genericFrameLocationProps.put(ID3V23_PAYLOAD_ID,
         new LocationProperties(DataBlockDescription.UNKNOWN_SIZE, 999999, 0,
            DataBlockDescription.UNKNOWN_SIZE, new ArrayList<>(),
            new ArrayList<>()));

      // Magic Keys
      MagicKey genericFrameMagicKey = new MagicKey(new byte[] { 0 }, Byte.SIZE,
         GENERIC_FRAME_HEADER_ID, 0);

      List<MagicKey> id3v23GenericFrameMagicKeys = new ArrayList<>();
      id3v23GenericFrameMagicKeys.add(genericFrameMagicKey);

      final DataBlockDescription genericBlockDesc = new DataBlockDescription(
         GENERIC_FRAME_ID, "GENERIC_ID3v23_FRAME", "The id3v23 GENERIC_FRAME",
         PhysicalDataBlockType.CONTAINER, genericFrameChildIds,
         ChildOrder.SEQUENTIAL, null, genericFrameLocationProps, 11,
         DataBlockDescription.UNKNOWN_SIZE, id3v23GenericFrameMagicKeys, null);
      ...
      textEncLocationProps.put(GENERIC_FRAME_PAYLOAD_ID,
         new LocationProperties(0, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      textEncFieldFunctions
         .add(new FieldFunction(FieldFunctionType.CHARACTER_ENCODING_OF,
            affectedTextEncIds, null, null));

      DataBlockDescription textEncDesc = new DataBlockDescription(
         GENERIC_TEXT_ENCODING_ID, "Text encoding", "Text encoding",
         PhysicalDataBlockType.FIELD, textEncChildIds, ChildOrder.SEQUENTIAL,
         new FieldProperties<>(FieldType.ENUMERATED, Charsets.CHARSET_ISO,
            charsetsEnumerated, null, DataBlockDescription.UNKNOWN_SIZE,
            DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
            null, null, textEncFieldFunctions),
         textEncLocationProps, 1, 1, null, GENERIC_FRAME_PAYLOAD_DATA_FIELD_ID);
      ...
      descMap.put(GENERIC_INFORMATION_ID,
         new DataBlockDescription(GENERIC_INFORMATION_ID, "Information",
            "Information", PhysicalDataBlockType.FIELD, informationChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.STRING, null, null, null,
               DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, '\u0000', null, null, null,
               null, null, null, new ArrayList<>()),
            informationLocationProps, 1, DataBlockDescription.UNKNOWN_SIZE,
            null, GENERIC_FRAME_PAYLOAD_DATA_FIELD_ID));
      ...
      final String genericLocalId = genericId.getIdSegments()
         .get(genericId.getIdSegments().size() - 1);

      // 5. tpe1
      addConcreteContainerDescriptionFromGeneric(descMap, genericId,
         genericLocalId, TPE1_LOCAL_ID, textFrameChildren);

      // 6. tit2
      addConcreteContainerDescriptionFromGeneric(descMap, genericId,
         genericLocalId, TIT2_LOCAL_ID, textFrameChildren);

      // 7. trck
      addConcreteContainerDescriptionFromGeneric(descMap, genericId,
         genericLocalId, TRCK_LOCAL_ID, textFrameChildren);
    ...
    *
    */
   private void addPaddingContainer(
      Map<DataBlockId, DataBlockDescription> descMap) {

      // 1. Padding first field
      final Map<DataBlockId, LocationProperties> firstFieldLocationProps = new HashMap<>();
      final LocationProperties paddingfirstFieldLoc = new LocationProperties(0,
         1, 1, DataBlockDescription.UNKNOWN_SIZE, new ArrayList<>(),
         new ArrayList<>());
      ...
      descMap.put(PADDING_BYTES_FIELD_ID,
         new DataBlockDescription(PADDING_BYTES_FIELD_ID, "Padding bytes",
            "Padding bytes", PhysicalDataBlockType.FIELD, paddingBytesChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.BINARY, paddingByte, null, null,
               DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, new ArrayList<>()),
            paddingBytesLocationProps, 1, DataBlockDescription.UNKNOWN_SIZE,
            null, null));
      ...
      paddingPayloadLocationProps.put(PADDING_ID,
         new LocationProperties(1, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      descMap.put(PADDING_PAYLOAD_ID,
         new DataBlockDescription(PADDING_PAYLOAD_ID, "Padding payload",
            "Padding payload", PhysicalDataBlockType.PAYLOAD,
            paddingPayloadChildIds, ChildOrder.SEQUENTIAL, null,
            paddingPayloadLocationProps, 1, DataBlockDescription.UNKNOWN_SIZE,
            null, null));

      // 4. Padding Container
      MagicKey paddingMagicKey = new MagicKey(paddingByte, Byte.SIZE, "\u0000",
         PADDING_PAYLOAD_ID, MagicKey.NO_BACKWARD_READING, 0);
      ...
      paddingLocationProps.put(ID3V23_PAYLOAD_ID,
         new LocationProperties(DataBlockDescription.UNKNOWN_SIZE, 0, 1,
            DataBlockDescription.UNKNOWN_SIZE, new ArrayList<>(),
            new ArrayList<>()));

      descMap.put(PADDING_ID,
         new DataBlockDescription(PADDING_ID, "Padding", "Padding",
            PhysicalDataBlockType.CONTAINER, paddingChildIds,
            ChildOrder.SEQUENTIAL, null, paddingLocationProps, 1,
            DataBlockDescription.UNKNOWN_SIZE, paddingMagicKeys, null));
   }

   /**
    * @param descMap
    */
   private void addGenericFrameHeader(
      Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      genericIdFieldFunction.add(new FieldFunction(FieldFunctionType.ID_OF,
         affectedBlocks, null, null));

      descMap.put(GENERIC_FRAME_HEADER_FRAME_ID_FIELD_ID,
         new DataBlockDescription(GENERIC_FRAME_HEADER_FRAME_ID_FIELD_ID,
            "Generic frame id field", "The generic frame id field",
            PhysicalDataBlockType.FIELD, frameIdChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.STRING, null, null, null,
               FRAME_ID_SIZE, FRAME_ID_SIZE, null, null, null, null, null,
               Charsets.CHARSET_ISO, null, genericIdFieldFunction),
            frameIdLocationProps, FRAME_ID_SIZE, FRAME_ID_SIZE, null, null));
      ...
      genericFrameSizeFieldFunction.add(new FieldFunction(
         FieldFunctionType.SIZE_OF, affectedFrameSizeBlocks, null, null));

      descMap.put(GENERIC_FRAME_HEADER_FRAME_SIZE_FIELD_ID,
         new DataBlockDescription(GENERIC_FRAME_HEADER_FRAME_SIZE_FIELD_ID,
            "Generic frame size field", "The generic frame size field",
            PhysicalDataBlockType.FIELD, frameSizeChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<Integer>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, 4, 4, null, null, null, null, null,
               Charsets.CHARSET_ISO, null, genericFrameSizeFieldFunction),
            frameSizeLocationProps, 4, 4, null, null));
      ...
      frameFlagDescriptions
         .add(new FlagDescription(FRAME_FLAGS_TAG_ALTER_PRESERVATION,
            new BitAddress(0, 0), "", 1, null));
      frameFlagDescriptions
         .add(new FlagDescription(FRAME_FLAGS_FILE_ALTER_PRESERVATION,
            new BitAddress(0, 1), "", 1, null));
      frameFlagDescriptions.add(new FlagDescription(FRAME_FLAGS_READ_ONLY,
         new BitAddress(0, 2), "", 1, null));
      frameFlagDescriptions.add(new FlagDescription(FRAME_FLAGS_COMPRESSION,
         new BitAddress(1, 0), "", 1, null));
      frameFlagDescriptions.add(new FlagDescription(FRAME_FLAGS_ENCRYPTION,
         new BitAddress(1, 1), "", 1, null));
      frameFlagDescriptions.add(new FlagDescription(FRAME_FLAGS_GROUP_IDENTITY,
         new BitAddress(1, 2), "", 1, null));

      final byte[] defaultTagFlagBytes = new byte[] { 0, 0 };

      FlagSpecification id3v23FrameFlagSpec = new FlagSpecification(
         frameFlagDescriptions, ID3V23_FRAME_FLAG_SIZE, ByteOrder.BIG_ENDIAN,
         defaultTagFlagBytes);
      ...
      affectedDataBlockIdsCompression
         .add(GENERIC_FRAME_PAYLOAD_DECOMPRESSED_SIZE_FIELD_ID);
      ...
      frameFlagFunctions.add(new FieldFunction(FieldFunctionType.PRESENCE_OF,
         affectedDataBlockIdsCompression, FRAME_FLAGS_COMPRESSION, 1));
      frameFlagFunctions
         .add(new FieldFunction(FieldFunctionType.TRANSFORMATION_OF,
      ...
      frameFlagFunctions.add(new FieldFunction(FieldFunctionType.PRESENCE_OF,
         affectedDataBlockIdsGroup, FRAME_FLAGS_GROUP_IDENTITY, 1));

      Set<DataBlockId> affectedDataBlockIdsEncryption = new HashSet<>();

      affectedDataBlockIdsEncryption
         .add(GENERIC_FRAME_PAYLOAD_GROUP_ID_FIELD_ID);
      ...
      frameFlagFunctions.add(new FieldFunction(FieldFunctionType.PRESENCE_OF,
         affectedDataBlockIdsEncryption, FRAME_FLAGS_ENCRYPTION, 1));
      frameFlagFunctions
         .add(new FieldFunction(FieldFunctionType.TRANSFORMATION_OF,
            affectedDataBlockIdsEncryptionTrafo, FRAME_FLAGS_ENCRYPTION, 1));

      descMap.put(GENERIC_FRAME_HEADER_FRAME_FLAGS_FIELD_ID,
         new DataBlockDescription(GENERIC_FRAME_HEADER_FRAME_FLAGS_FIELD_ID,
            "Generic frame flags field", "The generic frame flags field",
            PhysicalDataBlockType.FIELD, frameFlagsChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.FLAGS, defaultFrameFlags, null,
               null, 2, 2, null, null, null, null, id3v23FrameFlagSpec, null,
               null, frameFlagFunctions),
            frameFlagsLocationProps, 2, 2, null, null));
      ...
      descMap.put(GENERIC_FRAME_HEADER_ID,
         new DataBlockDescription(GENERIC_FRAME_HEADER_ID,
            "Generic frame header", "The generic frame header",
            PhysicalDataBlockType.HEADER, frameHeaderChildIds,
            ChildOrder.SEQUENTIAL, null, frameHeaderLocationProps, 10, 10, null,
            null));
   }
    ...
    * @param descMap
    */
   private void addGenericFramePayload(
      Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      decompressedSizeLocationProps.put(GENERIC_FRAME_PAYLOAD_ID,
         new LocationProperties(0, 1, 0, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      descMap.put(GENERIC_FRAME_PAYLOAD_DECOMPRESSED_SIZE_FIELD_ID,
         new DataBlockDescription(
            GENERIC_FRAME_PAYLOAD_DECOMPRESSED_SIZE_FIELD_ID,
            "Decompressed size field", "The decompressed size field",
            ...
            new FieldProperties<Integer>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               ...
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, null),
            decompressedSizeLocationProps, 4, 4, null, null));
      ...
      descMap.put(GENERIC_FRAME_PAYLOAD_ENCRYPTION_METHOD_FIELD_ID,
         new DataBlockDescription(
            GENERIC_FRAME_PAYLOAD_ENCRYPTION_METHOD_FIELD_ID,
            "Encryption method field", "The encryption method field",
            PhysicalDataBlockType.FIELD, encryptionMethodChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<Byte>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, null),
            encryptionMethodLocationProps, 1, 1, null, null));
      ...
      descMap.put(GENERIC_FRAME_PAYLOAD_GROUP_ID_FIELD_ID,
         new DataBlockDescription(GENERIC_FRAME_PAYLOAD_GROUP_ID_FIELD_ID,
            "Group id field", "The group id field", PhysicalDataBlockType.FIELD,
            groupIdChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.UNSIGNED_WHOLE_NUMBER, null, null,
               null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null,
               new Byte((byte) 0x80), new Byte((byte) 0xFF), null, null, null,
               null),
            groupIdLocationProps, 1, 1, null, null));
      ...
      descMap.put(GENERIC_FRAME_PAYLOAD_DATA_FIELD_ID,
         new DataBlockDescription(GENERIC_FRAME_PAYLOAD_DATA_FIELD_ID,
            "Payload data field", "The payload data field",
            PhysicalDataBlockType.FIELD, payloadDataChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<BinaryValue>(FieldType.BINARY, null, null, null,
               DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, null),
            payloadDataLocationProps, 1, DataBlockDescription.UNKNOWN_SIZE,
            null, null));

      // 5 Generic Frame Payload
      final List<DataBlockId> genericFramePayloadChildIds = new ArrayList<>();
      genericFramePayloadChildIds
         .add(GENERIC_FRAME_PAYLOAD_DECOMPRESSED_SIZE_FIELD_ID);
      genericFramePayloadChildIds
         .add(GENERIC_FRAME_PAYLOAD_ENCRYPTION_METHOD_FIELD_ID);
      ...
      descMap.put(GENERIC_FRAME_PAYLOAD_ID,
         new DataBlockDescription(GENERIC_FRAME_PAYLOAD_ID,
            "Generic frame payload", "The generic frame payload",
            PhysicalDataBlockType.PAYLOAD, genericFramePayloadChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.UNSIGNED_WHOLE_NUMBER, null, null,
               null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null,
               new Byte((byte) 0x80), new Byte((byte) 0xFF), null, null, null,
               null),
            genericFramePayloadLocationProps, 1,
            DataBlockDescription.UNKNOWN_SIZE, null, null));
   }
   ...
   private void addHeader(Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      descMap.put(ID3V23_HEADER_ID_FIELD_ID,
         new DataBlockDescription(ID3V23_HEADER_ID_FIELD_ID,
            "id3v23 tag header id", "The id3v23 tag header id",
            PhysicalDataBlockType.FIELD, tagIdChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.STRING, ID3V23_TAG_ID_STRING,
               tagIdEnumerated, null, 3, 3, null, null, null, null, null,
               Charsets.CHARSET_ISO, null, new ArrayList<>()),
            tagIdLocationProps, 3, 3, null, null));
      ...
      versionLocationProps.put(ID3V23_HEADER_ID,
         new LocationProperties(3, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      descMap.put(ID3V23_HEADER_VERSION_FIELD_ID,
         new DataBlockDescription(ID3V23_HEADER_VERSION_FIELD_ID,
            "id3v23 tag header version", "The id3v23 tag header version",
            PhysicalDataBlockType.FIELD, versionChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.BINARY, ID3V23_TAG_VERSION_BYTES,
               versionEnumerated, null, 2, 2, null, null, null, null, null,
               null, null, new ArrayList<>()),
            versionLocationProps, 2, 2, null, null));
      ...
      flagsLocationProps.put(ID3V23_HEADER_ID,
         new LocationProperties(5, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      List<FlagDescription> tagFlagDescriptions = new ArrayList<>();

      tagFlagDescriptions.add(new FlagDescription(TAG_FLAGS_UNSYNCHRONIZATION,
         new BitAddress(0, 0), "", 1, null));
      tagFlagDescriptions.add(new FlagDescription(TAG_FLAGS_EXTENDED_HEADER,
         new BitAddress(0, 1), "", 1, null));
      tagFlagDescriptions.add(new FlagDescription(
         TAG_FLAGS_EXPERIMENTAL_INDICATOR, new BitAddress(0, 2), "", 1, null));

      final byte[] defaultTagFlagBytes = new byte[] { 0 };

      FlagSpecification id3v23TagFlagSpec = new FlagSpecification(
         tagFlagDescriptions, ID3V23_TAG_FLAG_SIZE, ByteOrder.BIG_ENDIAN,
         defaultTagFlagBytes);
      ...
      tagFlagFunctions.add(new FieldFunction(FieldFunctionType.PRESENCE_OF,
         affectedDataBlockIds, TAG_FLAGS_EXTENDED_HEADER, 1));
      tagFlagFunctions
         .add(new FieldFunction(FieldFunctionType.TRANSFORMATION_OF,
            affectedDataBlockIdsUnsync, TAG_FLAGS_UNSYNCHRONIZATION, 1));

      descMap.put(ID3V23_HEADER_FLAGS_FIELD_ID,
         new DataBlockDescription(ID3V23_HEADER_FLAGS_FIELD_ID,
            "id3v23 tag header flags", "The id3v23 tag header flags",
            PhysicalDataBlockType.FIELD, flagsChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.FLAGS, defaultTagFlags, null, null,
               DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null,
               id3v23TagFlagSpec, null, null, tagFlagFunctions),
            flagsLocationProps, ID3V23_TAG_FLAG_SIZE, ID3V23_TAG_FLAG_SIZE,
            null, null));
      ...
      sizeLocationProps.put(ID3V23_HEADER_ID,
         new LocationProperties(6, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      tagSizeFunc.add(new FieldFunction(FieldFunctionType.SIZE_OF,
         affectedTagSizeBlocks, null, null));

      descMap.put(ID3V23_HEADER_SIZE_FIELD_ID,
         new DataBlockDescription(ID3V23_HEADER_SIZE_FIELD_ID,
            "id3v23 tag size", "The id3v23 tag size",
            PhysicalDataBlockType.FIELD, sizeChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<Integer>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, tagSizeFunc),
            sizeLocationProps, 4, 4, null, null));
      ...
      descMap.put(ID3V23_HEADER_ID,
         new DataBlockDescription(ID3V23_HEADER_ID, "id3v23 tag header",
            "The id3v23 tag header", PhysicalDataBlockType.HEADER,
            headerChildIds, ChildOrder.SEQUENTIAL, null, headerLocationProps,
            10, 10, null, null));
   }

   private void addExtendedHeader(
      Map<DataBlockId, DataBlockDescription> descMap) {
      ...
      descMap.put(ID3V23_EXTENDED_HEADER_FIELD_SIZE_ID,
         new DataBlockDescription(ID3V23_EXTENDED_HEADER_FIELD_SIZE_ID,
            "id3v23 extended header size", "The id3v23 extended header size",
            PhysicalDataBlockType.FIELD, extHeaderSizeChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<Integer>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, 4, 4, null, null, null, null, null, null, null,
               new ArrayList<>()),
            extHeaderSizeLocationProps, 4, 4, null, null));
      ...
      final Map<DataBlockId, LocationProperties> flagsLocationProps = new HashMap<>();
      extHeaderSizeLocationProps.put(ID3V23_EXTENDED_HEADER_ID,
         new LocationProperties(4, 1, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));

      List<FlagDescription> extendedHeaderFlagDescriptions = new ArrayList<>();

      extendedHeaderFlagDescriptions.add(new FlagDescription(
         EXT_HEADER_FLAG_CRC_DATA_PRESENT, new BitAddress(0, 0), "", 1, null));

      final byte[] defaultTagFlagBytes = new byte[] { 0 };

      FlagSpecification id3v23TagFlagSpec = new FlagSpecification(
         extendedHeaderFlagDescriptions, 1, ByteOrder.BIG_ENDIAN,
         defaultTagFlagBytes);
      ...
      extHeaderFlagFunctions
         .add(new FieldFunction(FieldFunctionType.PRESENCE_OF,
            affectedDataBlockIds, EXT_HEADER_FLAG_CRC_DATA_PRESENT, 1));

      descMap.put(ID3V23_EXTENDED_HEADER_FIELD_FLAGS_ID,
         new DataBlockDescription(ID3V23_EXTENDED_HEADER_FIELD_FLAGS_ID,
            "id3v23 extended header flags", "The id3v23 extended header flags",
            PhysicalDataBlockType.FIELD, flagsChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.FLAGS, defaultExtHeaderFlags, null,
               null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, extHeaderFlagFunctions),
            flagsLocationProps, ID3V23_TAG_FLAG_SIZE, ID3V23_TAG_FLAG_SIZE,
            null, null));
      ...
      descMap.put(ID3V23_EXTENDED_HEADER_FIELD_PADDINGSIZE_ID,
         new DataBlockDescription(ID3V23_EXTENDED_HEADER_FIELD_PADDINGSIZE_ID,
            "id3v23 extended header padding size",
            "The id3v23 extended header padding size",
            PhysicalDataBlockType.FIELD, paddingSizeChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<Integer>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, new ArrayList<>()),
            paddingSizeLocationProps, 4, 4, null, null));
      ...
      descMap.put(ID3V23_EXTENDED_HEADER_FIELD_CRC_ID,
         new DataBlockDescription(ID3V23_EXTENDED_HEADER_FIELD_CRC_ID,
            "id3v23 extended header CRC", "The id3v23 extended header CRC",
            PhysicalDataBlockType.FIELD, crcChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<Integer>(FieldType.UNSIGNED_WHOLE_NUMBER, null,
               null, null, DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null, null,
               null, null, new ArrayList<>()),
            crcLocationProps, 4, 4, null, null));
      ...
      extHeaderLocationProps.put(ID3V23_TAG_ID,
         new LocationProperties(10, 1, 0, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      descMap.put(ID3V23_EXTENDED_HEADER_ID,
         new DataBlockDescription(ID3V23_EXTENDED_HEADER_ID,
            "id3v23 extended header", "The id3v23 extended header",
            PhysicalDataBlockType.HEADER, extHeaderChildIds,
            ChildOrder.SEQUENTIAL, null, extHeaderLocationProps, 10, 14, null,
            null));
   }
   ...
   private IDataFormatSpecification createSpecification(
      ...
      transformations.add(new DataTransformationType("Unsynchronisation",
         unsynchronisationContainers, true, 0, 0));

      IDataFormatSpecification dummyID3v23Spec = new StandardDataFormatSpecification(
         DefaultExtensionsDataFormat.ID3v23, descMap, topLevelIds,
         genericDataBlocks, paddingDataBlocks, supportedByteOrders,
         supportedCharsets, transformations);
      return dummyID3v23Spec;
   }

   @SuppressWarnings({ "unchecked", "rawtypes" })
   private void addConcreteContainerDescriptionFromGeneric(
      Map<DataBlockId, DataBlockDescription> descMap, DataBlockId genericId,
      String genericLocalId, String concreteLocalId,
      List<DataBlockId> concretePayloadChildren) {
      ...
      DataBlockId concreteId = replaceId(genericId, genericLocalId,
         concreteLocalId);
      String concreteSpecDesc = genericDesc.getSpecDescription()
         .replace(genericLocalId, concreteLocalId);
      String concreteName = genericDesc.getName().replace(genericLocalId,
         concreteLocalId);

      // Define all other items to replace
      List<DataBlockId> genericChildren = new ArrayList<>(
         genericDesc.getOrderedChildIds());
      List<DataBlockId> concreteChildren = new ArrayList<>();
      Map<DataBlockId, LocationProperties> concreteLocationProperties = new HashMap<>();
      FieldProperties<?> genericFieldProperties = genericDesc
         .getFieldProperties();
      FieldProperties<?> concreteFieldProperties = genericDesc
         .getFieldProperties();
      ...
      if (genericDesc.getPhysicalType().equals(PhysicalDataBlockType.PAYLOAD))
         if (concretePayloadChildren != null) {
            for (int i = 0; i < concretePayloadChildren.size(); ++i) {
               DataBlockId concretePayloadChildId = concretePayloadChildren
                  .get(i);

               final DataBlockId overriddenId = descMap
                  .get(concretePayloadChildId).getOverriddenId();

               if (overriddenId != null
                  && genericChildren.contains(overriddenId))
      ...
      for (int i = 0; i < genericChildren.size(); ++i) {
         ...
         addConcreteContainerDescriptionFromGeneric(descMap, genericChildId,
            genericLocalId, concreteLocalId, concretePayloadChildren);

         concreteChildren
            .add(replaceId(genericChildId, genericLocalId, concreteLocalId));
      }

      // Replace location properties
      for (Iterator<DataBlockId> iterator = genericDesc
         .getAllParentsForLocationProperties().iterator(); iterator
            .hasNext();) {
         DataBlockId genericLocationParentId = iterator.next();
         LocationProperties locProp = genericDesc
            .getLocationPropertiesForParent(genericLocationParentId);

         concreteLocationProperties.put(
            replaceId(genericLocationParentId, genericLocalId, concreteLocalId),
            locProp);
      }
      ...
      if (genericFieldProperties != null) {
         ...
         for (int i = 0; i < genericFieldProperties.getFieldFunctions()
            .size(); ++i) {
            FieldFunction genericFunction = genericFieldProperties
               .getFieldFunctions().get(i);

            Set<DataBlockId> concreteAffectedIds = new HashSet<>();

            for (Iterator<DataBlockId> affectedBlockIterator = genericFunction
               .getAffectedBlockIds().iterator(); affectedBlockIterator
                  .hasNext();) {
               DataBlockId genericAffectedBlockId = affectedBlockIterator
                  .next();

               concreteAffectedIds.add(replaceId(genericAffectedBlockId,
                  genericLocalId, concreteLocalId));
            }

            concreteFieldFunctions.add(new FieldFunction(
               genericFunction.getFieldFunctionType(), concreteAffectedIds,
               genericFunction.getFlagName(), genericFunction.getFlagValue()));
         }

         concreteFieldProperties = new FieldProperties(
            genericFieldProperties.getFieldType(),
            genericFieldProperties.getDefaultValue(),
            genericFieldProperties.getEnumeratedValues(),
            genericFieldProperties.getTerminationBytes(),
            genericFieldProperties.getMinimumCharacterLength(),
            genericFieldProperties.getMaximumCharacterLength(),
            genericFieldProperties.getTerminationCharacter(),
            genericFieldProperties.getPatterns(),
            genericFieldProperties.getMinimumValue(),
            genericFieldProperties.getMaximumValue(),
            genericFieldProperties.getFlagSpecification(),
            genericFieldProperties.getFixedCharacterEncoding(),
            genericFieldProperties.getFixedByteOrder(), concreteFieldFunctions);
      }

      // Create concrete block description
      DataBlockDescription concreteDesc = new DataBlockDescription(concreteId,
         concreteName, concreteSpecDesc, genericDesc.getPhysicalType(),
         concreteChildren, genericDesc.getChildOrder(), concreteFieldProperties,
         concreteLocationProperties, genericDesc.getMinimumByteLength(),
         genericDesc.getMaximumByteLength(), genericDesc.getMagicKeys(), null);
   ...
   public String getExtensionId() {
      ...
      return "DEFAULT_de.je.jmeta.defext.dataformats.impl.ID3v23DummyDataFormatExtension";
   }

   private DataBlockId replaceId(DataBlockId genericId, String genericLocalId,
