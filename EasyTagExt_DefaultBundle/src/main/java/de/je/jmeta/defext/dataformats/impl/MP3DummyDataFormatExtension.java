...
/**
 * {@link MP3DummyDataFormatExtension}
 *
 */
public class MP3DummyDataFormatExtension implements IDataFormatsExtension {
   ...
   public DataFormat getDataFormat() {
      ...
      return DefaultExtensionsDataFormat.MP3;
   }
   ...
   public IDataFormatSpecification getSpecification() {
      ...
      // Data blocks
      final DataBlockId mp3FrameId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3");
      final DataBlockId mp3HeaderId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3.header");
      final DataBlockId mp3CRCId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3.crc");
      final DataBlockId mp3CRCFieldId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3.crc.data");
      final DataBlockId mp3PayloadId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3.payload");
      final DataBlockId mp3PayloadDataId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3.payload.data");
      final DataBlockId mp3HeaderContentId = new DataBlockId(
         DefaultExtensionsDataFormat.MP3, "mp3.header.content");
      ...
      flagDescriptions.add(new FlagDescription("Frame sync",
         new BitAddress(0, 0), "", FRAME_SYNC_BIT_COUNT, null));

      flagDescriptions.add(new FlagDescription("No protection bit",
      ...
      flagDescriptions.add(new FlagDescription("Layer", new BitAddress(1, 1),
         "", 2, layerValueNames));
      ...
      flagDescriptions.add(
         new FlagDescription("Id", new BitAddress(1, 3), "", 2, idValueNames));

      flagDescriptions.add(
         new FlagDescription("Private bit", new BitAddress(2, 0), "", 1, null));
      flagDescriptions.add(
         new FlagDescription("Padding bit", new BitAddress(2, 1), "", 1, null));
      flagDescriptions.add(new FlagDescription("Sampling frequency",
         new BitAddress(2, 2), "", 2, null));
      flagDescriptions.add(new FlagDescription("Bitrate index",
         new BitAddress(2, 4), "", 4, null));
      flagDescriptions.add(new FlagDescription("Emphasis bit",
         new BitAddress(3, 0), "", 2, null));
      flagDescriptions.add(new FlagDescription("Original or copy",
         new BitAddress(3, 2), "", 1, null));
      flagDescriptions.add(new FlagDescription("Copyright bit",
         new BitAddress(3, 3), "", 1, null));
      flagDescriptions.add(new FlagDescription("Mode extension bit",
         new BitAddress(3, 4), "", 2, null));
      flagDescriptions.add(
         new FlagDescription("Mode bit", new BitAddress(3, 6), "", 2, null));

      FlagSpecification mp3HeaderFlagSpec = new FlagSpecification(
         flagDescriptions, MP3_HEADER_BYTE_LENGTH, ByteOrder.BIG_ENDIAN,
         new byte[MP3_HEADER_BYTE_LENGTH]);
      ...
      functions.add(new FieldFunction(FieldFunctionType.PRESENCE_OF,
         affectedBlocks, "No protection bit", 0));

      descMap.put(mp3HeaderContentId,
         new DataBlockDescription(mp3HeaderContentId, "MP3 header contents",
            "The MP3 header contents", PhysicalDataBlockType.FIELD,
            headerContentChildIds, ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.FLAGS, defaultFlags, null, null,
               DataBlockDescription.UNKNOWN_SIZE,
               DataBlockDescription.UNKNOWN_SIZE, null, null, null, null,
               mp3HeaderFlagSpec, null, null, null),
            headerContentLocationProps, MP3_HEADER_BYTE_LENGTH,
      ...
      descMap.put(mp3HeaderId,
         new DataBlockDescription(mp3HeaderId, "MP3 header", "The MP3 header",
            PhysicalDataBlockType.HEADER, headerChildIds, ChildOrder.SEQUENTIAL,
            null, headerLocationProps, MP3_HEADER_BYTE_LENGTH,
            MP3_HEADER_BYTE_LENGTH, null, null));
      ...
      crcFieldLocationProps.put(mp3FrameId,
         new LocationProperties(4, 0, 1, DataBlockDescription.UNKNOWN_SIZE,
            new ArrayList<>(), new ArrayList<>()));
      ...
      descMap.put(mp3CRCId,
         new DataBlockDescription(mp3CRCId, "MP3 CRC data", "The MP3 CRC data",
            PhysicalDataBlockType.FIELD, crcFieldChildIds,
            ChildOrder.SEQUENTIAL,
            new FieldProperties<>(FieldType.BINARY, null, null, null, 2, 2,
      ...
      descMap.put(mp3CRCId,
         new DataBlockDescription(mp3CRCId, "MP3 CRC", "The MP3 CRC",
            PhysicalDataBlockType.HEADER, crcChildIds, ChildOrder.SEQUENTIAL,
            null, crcLocationProps, 2, 2, null, null));
      ...
      descMap.put(mp3PayloadDataId, new DataBlockDescription(mp3PayloadDataId,
         "payloadData", "The MP3 payload data", PhysicalDataBlockType.FIELD,
         payloadDataChildIds, ChildOrder.SEQUENTIAL,
         new FieldProperties<>(FieldType.BINARY, null, null, null,
            DataBlockDescription.UNKNOWN_SIZE,
      ...
      descMap.put(mp3PayloadId,
         new DataBlockDescription(mp3PayloadId, "payload", "The MP3 payload",
            PhysicalDataBlockType.PAYLOAD, payloadChildIds,
            ChildOrder.SEQUENTIAL, null, payloadLocationProps, 1, 998, null,
            null));
      ...
      descMap.put(mp3FrameId,
         new DataBlockDescription(mp3FrameId, "MP3 Frame", "The MP3 Frame",
            PhysicalDataBlockType.CONTAINER, frameChildIds,
            ChildOrder.SEQUENTIAL, null, frameLocationProps, 33, 1024,
            mp3FrameMagicKeys, null));
      ...
      IDataFormatSpecification dummyMP3Spec = new StandardDataFormatSpecification(
         DefaultExtensionsDataFormat.MP3, descMap, topLevelIds, new HashSet<>(),
         new HashSet<>(), supportedByteOrders, supportedCharsets,
   ...
   public String getExtensionId() {
      ...
      return "DEFAULT_de.je.jmeta.defext.dataformats.impl.MP3DummyDataFormatExtension";
   }
