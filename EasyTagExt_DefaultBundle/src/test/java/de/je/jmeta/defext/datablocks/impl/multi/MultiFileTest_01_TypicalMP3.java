...
public class MultiFileTest_01_TypicalMP3 extends AbstractDataBlockAccessorDefaultExtensionTest {
   ...
   private final static Path THE_FILE = TestResourceHelper
      .resourceToFile(AbstractDataBlockAccessorDefaultExtensionTest.class, "multi/Multi_FILE_01_TypicalMP3.txt");

   private final static Path THE_CSV_FILE = TestResourceHelper.resourceToFile(
      AbstractDataBlockAccessorDefaultExtensionTest.class, "multi/Expected_Multi_FILE_01_TypicalMP3.csv");
}
