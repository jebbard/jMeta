 ...
 */
public class ID3v23SingleFileTest_03_NoPadding extends AbstractDataBlockAccessorDefaultExtensionTest {
   ...
   private final static Path THE_FILE = TestResourceHelper
      .resourceToFile(AbstractDataBlockAccessorDefaultExtensionTest.class, "id3v23/ID3v23_FILE_03_NoPadding.txt");

   private final static Path THE_CSV_FILE = TestResourceHelper.resourceToFile(
      AbstractDataBlockAccessorDefaultExtensionTest.class, "id3v23/Expected_ID3v23_FILE_03_NoPadding.csv");
}
