 ...
 */
public class ID3v1SingleFileTest_01 extends AbstractDataBlockAccessorDefaultExtensionTest {
   ...
   private final static Path THE_FILE = TestResourceHelper.resourceToFile(ID3v1SingleFileTest_01.class,
      "ID3v1_FILE_01.txt");

   private final static Path THE_CSV_FILE = TestResourceHelper.resourceToFile(ID3v1SingleFileTest_01.class,
