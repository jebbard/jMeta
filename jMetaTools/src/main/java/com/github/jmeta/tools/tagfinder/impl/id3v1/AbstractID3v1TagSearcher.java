...
public abstract class AbstractID3v1TagSearcher extends AbstractMagicKeyTagSearcher {
	...
	public AbstractID3v1TagSearcher(String tagName) {
		super(new byte[] { 'T', 'A', 'G' }, new long[] { -AbstractID3v1TagSearcher.ID3V1_TAG_SIZE }, tagName);
	}
	...
	public TagInfo getTagInfo(RandomAccessFile file) {
		...
		if (tagInfo != null) {
			...
			idBytes[0] = tagInfo.getTagBytes()[AbstractID3v1TagSearcher.COMMENT_NULL_BYTE_OFFSET];
			idBytes[1] = tagInfo.getTagBytes()[AbstractID3v1TagSearcher.COMMENT_NULL_BYTE_OFFSET + 1];
	...
	protected int getTotalTagSize(RandomAccessFile file, long possibleOffset) {
		...
		return AbstractID3v1TagSearcher.ID3V1_TAG_SIZE;
	}
