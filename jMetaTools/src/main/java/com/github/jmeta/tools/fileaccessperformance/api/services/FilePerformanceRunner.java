 ...
 * <li>- Using {@link BufferedInputStream} and {@link BufferedOutputStream} around {@link FileInputStream} and
 * {@link FileOutputStream}</li>
 * <li>- Using {@link FileInputStream} and {@link FileOutputStream} together with their {@link FileChannel}</li>
 * <li>- Using {@link BufferedInputStream} and {@link BufferedOutputStream} around {@link FileInputStream} and
 * {@link FileOutputStream} together with their {@link FileChannel}</li>
 * <li>- Using {@link FileInputStream} and {@link FileOutputStream} together with their {@link FileChannel}'s
 * {@link MappedByteBuffer}</li>
 * </ul>
 *
 ...
 * <ul>
 * <li>(a) Read [bytes to read] + [bytes at end] bytes from the file starting from offset (file size - [bytes at end] -
 * [bytes to read])
 * <li>(b) Write [bytes to write] randomly generated bytes to the file starting from offset (file size - [bytes at end]
...
public class FilePerformanceRunner implements MeasurementCommandListener {
   ...
   public FilePerformanceRunner(File testFile, int bytesToRead, int bytesToWrite, int bytesAtEnd,
      ...
      this.m_testFile = testFile;
      this.m_bytesToRead = bytesToRead;
      this.m_bytesToWrite = bytesToWrite;
      this.m_bytesAtEnd = bytesAtEnd;
    ...
    * @throws IOException
    *            In case of any problems during file access
    */
