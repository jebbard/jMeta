...
/**
 * {@link TwoColumnCsvFileTest} tests the {@link CsvReader} class with a two column CSV file, with default quote and
 * specific separator, with some quoted columns that contain separators within the quote.
 *
 * Furthermore, some of the lines contain empty last columns and some lines just consist of one separator.
 */
