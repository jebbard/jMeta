...
/**
 * {@link ID3v23SingleFile_02_SinglePaddingByteTest} tests reading a single ID3v23 tag with a single padding byte.
 */
public class ID3v23SingleFile_02_SinglePaddingByteTest extends AbstractDataBlockAccessorTest {
   ...
   private final static Path THE_CSV_FILE = TestResourceHelper
      .resourceToFile(ID3v23SingleFile_02_SinglePaddingByteTest.class, "Expected_ID3v23_FILE_02_SinglePaddingByte.csv");
}
