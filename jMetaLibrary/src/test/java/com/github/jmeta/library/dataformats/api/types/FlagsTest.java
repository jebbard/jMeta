...
public abstract class FlagsTest {
	 ...
	 *
	 * @throws PreconditionUnfullfilledException If data is not valid with a
	 *                                           speaking message what is wrong in
	 *                                           detail.
	 */
	private void checkTestData() {
		if (m_flagsBigEndian.getSpecification().getByteOrdering() != ByteOrder.BIG_ENDIAN) {
			throw new InvalidTestDataException("Byte ordering for the big endian spec must be ByteOrder.BIG_ENDIAN",
				null);
		}

		if (m_flagsLittleEndian.getSpecification().getByteOrdering() != ByteOrder.LITTLE_ENDIAN) {
			throw new InvalidTestDataException(
				"Byte ordering for the little endian spec must be ByteOrder.LITTLE_ENDIAN", null);
		}
	}
	...
	/**
	 * Tests all as and from methods for retrieving the same value that has been
	 * set.
	 */
	@Test
	...
	/**
	 * Tests {@link Flags#asByte()}, {@link Flags#asShort()}, {@link Flags#asInt()},
	 * {@link Flags#asLong()} for returning zero if all flags are not set.
	 */
	@Test
	...
	/**
	 * Tests {@link Flags#asShort}, {@link Flags#asInt}, {@link Flags#asLong} for
	 * throwing an {@link PreconditionUnfullfilledException} correctly.
	 */
	@Test
	...
	/**
	 * Tests {@link Flags#fromShort}, {@link Flags#fromInt}, {@link Flags#fromLong}
	 * if setting all flags numerically works correctly.
	 */
	@Test
	...
	/**
	 * Tests {@link Flags#fromShort}, {@link Flags#fromInt}, {@link Flags#fromLong}
	 * for throwing an {@link PreconditionUnfullfilledException} correctly.
	 */
	@Test
	...
	/**
	 * Tests {@link Flags#setFlag(String, boolean)} and
	 * {@link Flags#getFlag(String)}.
	 */
	@Test
	 ...
	 * set.
	 *
	 * @param flags The {@link Flags} to test.
	 */
