	...
	protected List<FlagDescription> getFlagDescriptions() {
		if (m_enhancedDescriptions.isEmpty()) {
			...
			m_enhancedDescriptions
				.add(new FlagDescription(Flags8ByteTest.RESERVED_8_FLAG, new BitAddress(7, 0), "", 1, null));
			m_enhancedDescriptions.add(new FlagDescription(Flags8ByteTest.XWORLD, new BitAddress(7, 2), "", 1, null));
			m_enhancedDescriptions
				.add(new FlagDescription(Flags8ByteTest.ANGER_3_FLAG, new BitAddress(7, 4), "", 1, null));
			m_enhancedDescriptions
				.add(new FlagDescription(Flags8ByteTest.OCTSYNCHRONISATION_FLAG, new BitAddress(7, 6), "", 1, null));
		}
