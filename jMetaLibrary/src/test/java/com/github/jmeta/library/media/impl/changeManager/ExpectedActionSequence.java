 ...
 * 
 * Basically, each {@link ExpectedActionSequence} has a start {@link MediumOffset} that marks the start offset of
...
public abstract class ExpectedActionSequence {
   ...
   /**
    * Returns the start {@link MediumOffset} of this {@link ExpectedActionSequence}.
    * 
    * @return the start {@link MediumOffset} of this {@link ExpectedActionSequence}.
    */
    ...
    * @param expectedRef
    *           The expected {@link MediumOffset} of the next {@link MediumAction}.
    * @param expectedSize
    ...
    *           The expected start {@link MediumOffset} of the {@link MediumAction}
