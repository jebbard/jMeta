 ...
 * 
 * Test methods for {@link MediumChangeManager#scheduleInsert(MediumRegion, ByteBuffer)},
 * {@link MediumChangeManager#scheduleRemove(MediumRegion)} and
 * {@link MediumChangeManager#scheduleReplace(MediumRegion, ByteBuffer)} follow a specific naming pattern:
 * 
...
public class MediumChangeManagerTest {
   ...
   public void dd079case1_scheduleInsertThenRemove_removedRangeDoesNotContainInsertOffset_iteratedUnchangedInOffsetOrder() {
      ...
      MediumRegion region1 = new MediumRegion(at(12), 5);
      MediumRegion region2 = new MediumRegion(at(100), BUFFER_SIZE_10_A.remaining());
   ...
   public void dd079case2_scheduleRemoveThenInsert_removedRangeDoesNotContainInsertOffset_iteratedUnchangedInOffsetOrder() {
      ...
      // Regions are listed in order of scheduling
      MediumRegion region0 = new MediumRegion(at(12), 5);
      MediumRegion region1 = new MediumRegion(at(10), BUFFER_SIZE_10_A.remaining());
      MediumRegion region2 = new MediumRegion(at(20), 55);
   ...
   public void dd079case5_scheduleInsertThenRemove_removedRangeContainsInsertOffset_iteratorOnlyReturnsRemove() {
      ...
      // Regions are listed in order of scheduling
      MediumRegion region0 = new MediumRegion(at(1), BUFFER_SIZE_10_A.remaining());
      MediumRegion region1 = new MediumRegion(at(0), 5);
      MediumRegion region2 = new MediumRegion(at(200), BUFFER_SIZE_10_A.remaining());
   ...
   public void dd079case5_scheduleInsertThenRemove_removedRangeContainsMultipleInsertOffsets_iteratorOnlyReturnsRemove() {
      ...
      // Regions are listed in order of scheduling
      MediumRegion region0 = new MediumRegion(at(1), BUFFER_SIZE_10_A.remaining());
      MediumRegion region1 = new MediumRegion(at(2), BUFFER_SIZE_5.remaining());
      MediumRegion region2 = new MediumRegion(at(2), BUFFER_SIZE_40.remaining());
   ...
   public void dd079case6_scheduleRemoveThenInsert_removedRangeContainsInsertOffset_throwsException() {
      ...
      // Regions are listed in order of scheduling
      MediumRegion region0 = new MediumRegion(at(0), 5);
      MediumRegion region1 = new MediumRegion(at(1), BUFFER_SIZE_10_A.remaining());
      MediumRegion region2 = new MediumRegion(at(199), 5);
   ...
   public void dd080case1_scheduleInsertThenReplace_replacedRangeDoesNotContainInsertOffset_iteratedUnchangedInOffsetOrder() {
      ...
      // Regions are listed in order of scheduling
      MediumRegion region0 = new MediumRegion(at(1), BUFFER_SIZE_10_A.remaining());
      MediumRegion region1 = new MediumRegion(at(2), 5);
      MediumRegion region2 = new MediumRegion(at(20), BUFFER_SIZE_20.remaining());
   ...
   public void dd080case2_scheduleReplaceThenInsert_replacedRangeDoesNotContainInsertOffset_iteratedUnchangedInOffsetOrder() {
      ...
      // Regions are listed in order of scheduling
      MediumRegion region0 = new MediumRegion(at(2), 5);
      MediumRegion region1 = new MediumRegion(at(1), BUFFER_SIZE_10_A.remaining());
      MediumRegion region2 = new MediumRegion(at(45), BUFFER_SIZE_20.remaining());
   ...
   public void dd080case5_scheduleInsertThenReplace_replacedRangeContainsMultipleInsertOffsets_iteratorOnlyReturnsReplace() {
      ...
      MediumRegion region0 = new MediumRegion(at(10), BUFFER_SIZE_10_A.remaining());
      MediumRegion region1 = new MediumRegion(at(2), BUFFER_SIZE_5.remaining());
      MediumRegion region2 = new MediumRegion(at(20), BUFFER_SIZE_40.remaining());
      MediumRegion region3 = new MediumRegion(at(2), BUFFER_SIZE_10_A.remaining());
   ...
   public void dd080case6_scheduleReplaceThenInsert_replacedRangeContainsInsertOffset_throwsException() {
      ...
      MediumRegion region1 = new MediumRegion(at(10), BUFFER_SIZE_10_A.remaining());
      MediumRegion region2 = new MediumRegion(at(100), BUFFER_SIZE_20.remaining());
      MediumRegion region3 = new MediumRegion(at(101), BUFFER_SIZE_5.remaining());
      MediumRegion region4 = new MediumRegion(at(200), BUFFER_SIZE_5.remaining());
   ...
   public void schedule_complexCaseNoOverlaps_iteratorReturnsActionsInExpectedOrder() {
      ...
      MediumRegion region3 = new MediumRegion(at(0), 20);
      ...
      MediumRegion region8 = new MediumRegion(at(188), 40);
      MediumRegion region9 = new MediumRegion(at(188), 20);
      MediumRegion region10 = new MediumRegion(at(188), 5);
      MediumRegion region11 = new MediumRegion(at(1300), 20);// Completely enclosed by region12 and thus ignored
      MediumRegion region12 = new MediumRegion(at(1299), 40);
   ...
   public void undo_forMultipleKnownActions_invalidatesAndIteratorDoesNotReturnActions() {
      ...
      MediumAction act4 = testling.scheduleInsert(new MediumRegion(at(58), BUFFER_SIZE_40.remaining()), BUFFER_SIZE_40);
