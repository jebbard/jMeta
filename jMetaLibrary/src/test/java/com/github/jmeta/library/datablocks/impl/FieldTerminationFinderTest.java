...
/**
 * {@link FieldTerminationFinderTest} tests the {@link FieldTerminationFinder}
 * class. It is parameterized by:
 * <ul>
...
public class FieldTerminationFinderTest {
	...
	/**
	 * {@link TestFieldDataProvider} is a helper {@link FieldDataProvider} that
	 * provides binary data from a string.
	 */
	...
	/**
	 * Returns a string with pure US-ASCII-only characters, including an optional
	 * termination character at a fixed place.
	 *
	 * @param termination The termination character to use or null if none to use
	 * @return The string with the termination character stuffed in at a fixed
	 *         offset
	 */
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			/*
			 * String containing only US-ASCII characters, US-ASCII encoding, varying block
			 * sizes
			 */
			...
			{ (Function<Character, String>) FieldTerminationFinderTest::asciiString, 1111, Charsets.CHARSET_ASCII,
				281 },
			/*
			 * String containing only US-ASCII characters, UTF-16 encoding, varying block
			 * sizes
			 */
			...
			{ (Function<Character, String>) FieldTerminationFinderTest::asciiString, 1111, Charsets.CHARSET_UTF16,
				564 },
			/*
			 * String containing only US-ASCII characters, UTF-8 encoding, varying block
			 * sizes
			 */
			...
			/*
			 * String containing also NON-US-ASCII characters, UTF-16 encoding, varying
			 * block sizes
			 */
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 100, Charsets.CHARSET_UTF16,
				98 },
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 12, Charsets.CHARSET_UTF16,
				98 },
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 33, Charsets.CHARSET_UTF16,
				98 },
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 210, Charsets.CHARSET_UTF16,
				98 },
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 303, Charsets.CHARSET_UTF16,
				98 },
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 999, Charsets.CHARSET_UTF16,
				98 },
			/*
			 * String containing also NON-US-ASCII characters, UTF-8 encoding, varying block
			 * sizes
			 */
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 100, Charsets.CHARSET_UTF8,
				72 },
			...
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 210, Charsets.CHARSET_UTF8,
				72 },
			{ (Function<Character, String>) FieldTerminationFinderTest::nonAsciiString, 303, Charsets.CHARSET_UTF8,
				72 },
	...
	/**
	 * Returns a string with some non US-ASCII characters, including an optional
	 * termination character at a fixed place.
	 *
	 * @param termination The termination character to use or null if none to use
	 * @return The string with the termination character stuffed in at a fixed
	 ...
	 *
	 * @param inputStringProviderFunc          A function providing an input test
	 *                                         string with the given termination
	 *                                         character; passing to it null means
	 *                                         it returns a string without
	 *                                         termination character; it returns
	 *                                         either a pure US-ASCII string or a
	 *                                         string with some non-US-ASCII
	 *                                         characters
	 * @param readBlockSize                    The block size used for reading
	 * @param charset                          The {@link Charset} to use
	 * @param expectedByteCountUpToTermination The expected length returned by
	 *                                         {@link FieldTerminationFinder#getSizeUntilTermination(Charset, Character, FieldDataProvider, long, int)},
	 *                                         if terminated including the
	 *                                         termination bytes
	 */
	...
	public void getSizeUpToTermination_withoutTerminationWithLimitBefore_returnsLimit() {
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(null), 10L, 10L,
			FieldTerminationFinderTest.TERMINATION_CHARACTER_1);
	}
	...
	public void getSizeUpToTermination_withTerminationWithLimitBefore_returnsLimit() {
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(FieldTerminationFinderTest.TERMINATION_CHARACTER_1),
			10L, 10L, FieldTerminationFinderTest.TERMINATION_CHARACTER_1);
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(FieldTerminationFinderTest.TERMINATION_CHARACTER_2),
			10L, 10L, FieldTerminationFinderTest.TERMINATION_CHARACTER_2);
	}
	...
	public void getSizeUpToTermination_withTerminationWithLimitBehind_returnsByteSizeUpToTermination() {
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(FieldTerminationFinderTest.TERMINATION_CHARACTER_1),
			expectedByteCountUpToTermination + 2, expectedByteCountUpToTermination,
			FieldTerminationFinderTest.TERMINATION_CHARACTER_1);
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(FieldTerminationFinderTest.TERMINATION_CHARACTER_2),
			expectedByteCountUpToTermination + 2, expectedByteCountUpToTermination,
			FieldTerminationFinderTest.TERMINATION_CHARACTER_2);
	}
	...
	public void getSizeUpToTermination_withTerminationWithoutLimit_returnsByteSizeUpToTermination() {
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(FieldTerminationFinderTest.TERMINATION_CHARACTER_1),
			DataBlockDescription.UNDEFINED, expectedByteCountUpToTermination,
			FieldTerminationFinderTest.TERMINATION_CHARACTER_1);
		assertExpectedSizeIsReturned(inputStringProviderFunc.apply(FieldTerminationFinderTest.TERMINATION_CHARACTER_2),
			DataBlockDescription.UNDEFINED, expectedByteCountUpToTermination,
			FieldTerminationFinderTest.TERMINATION_CHARACTER_2);
