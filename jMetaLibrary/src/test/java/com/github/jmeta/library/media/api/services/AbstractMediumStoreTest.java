 ...
 * <li>{@link AbstractWritableRandomAccessMediumStoreTest}: Tests based on a cached, writable and thus random-access
 * medium; additional "normal" write test cases go here and no parameter negative tests</li>
