...
/**
 * {@link MediumEqualityTest} tests the {@link Medium} interface and its
 * implementations for {@link #equals(Object)} and {@link #hashCode()}.
 */
public class MediumEqualityTest extends AbstractEqualsTest<Medium<?>> {
	...
	private List<Medium<?>> createDifferentMedia() {
		...
		// method
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_3, "different name", true));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_4, "Hallo3", false));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_1, "Hallo2", true));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_2, "Hallo1", false));
	...
	/**
	 * Creates the media equal to what {@link #createMedia()} returns for equality
	 * testing.
	 * 
	...
	private List<Medium<?>> createEqualMedia() {
		...
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_4, "different name", true));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_3, "Hallo3", true));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_2, "Hallo2", false));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_1, "Hallo1", false));
		media.add(new InputStreamMedium(MediumEqualityTest.CENTRAL_BYTE_ARRAY_INPUT_STREAM, "Tschau"));
		media.add(new InputStreamMedium(MediumEqualityTest.CENTRAL_BUFFERED_INPUT_STREAM, "bye"));
	...
	private List<Medium<?>> createMedia() {
		...
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_4, "Hallo4", true));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_3, "Hallo3", false));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_2, "Hallo2", true));
		media.add(new InMemoryMedium(MediumEqualityTest.BYTE_ARRAY_1, "Hallo1", false));
