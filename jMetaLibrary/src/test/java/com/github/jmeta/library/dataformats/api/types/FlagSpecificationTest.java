...
public class FlagSpecificationTest {
	...
	/**
	 * Test
	 * {@link FlagSpecification#FlagSpecification(List, int, ByteOrder, byte[])} for
	...
	public void test_constructor_exception() {
		...
		try {
			...
			Assert
				.fail("Exception expected: " + PreconditionUnfullfilledException.class.getName() + " for " + flagSpec);
