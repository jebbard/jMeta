...
public interface TestMedia {
    ...
    */
   FileMedium DEFAULT_TEST_MEDIUM = new FileMedium(TestMedia.FIRST_TEST_FILE_PATH, MediumAccessType.READ_ONLY);

   /**
    * A second test {@link Medium} to be used whenever checks require another {@link Medium} than the
    * {@link #DEFAULT_TEST_MEDIUM}.
    */
   InMemoryMedium OTHER_MEDIUM = new InMemoryMedium(new byte[] { 0 }, "Fake", MediumAccessType.READ_WRITE);
   ...
   static void validateTestFiles() {
      ...
      TestMedia.checkFile(TestMedia.FIRST_TEST_FILE_PATH, TestMedia.FIRST_TEST_FILE_CONTENT, "FIRST_TEST_FILE_CONTENT");
      TestMedia.checkFile(TestMedia.SECOND_TEST_FILE_PATH, TestMedia.SECOND_TEST_FILE_CONTENT,
         "SECOND_TEST_FILE_CONTENT");
      TestMedia.checkFile(TestMedia.EMPTY_TEST_FILE_PATH, TestMedia.EMPTY_TEST_FILE_CONTENT, "EMPTY_TEST_FILE_CONTENT");
   }
}
