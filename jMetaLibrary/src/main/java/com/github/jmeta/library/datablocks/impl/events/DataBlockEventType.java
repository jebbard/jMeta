...
public enum DataBlockEventType {
   ...
   MODIFIED,
   /**
    * All {@link DataBlock} changes have been flushed; causing {@link DataBlock} is null here
    */
   FLUSHED,
   /**
    * All {@link DataBlock} changes have been reset; causing {@link DataBlock} is null here
    */
   RESET_ALL,
   /**
