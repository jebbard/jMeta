...
public class InMemoryMedium extends AbstractMedium<ByteBuffer> {
	...
	/**
	 * Creates a new {@link InMemoryMedium} with default values for all properties
	 * that influence reading and writing. Note that caching is always disable for
	 * an {@link InMemoryMedium}.
	 *
	 * @param medium   See
	 *                 {@link #InMemoryMedium(byte[], String, boolean, long, int)}
	 * @param name     See
	 *                 {@link #InMemoryMedium(byte[], String, boolean, long, int)}
	 * @param readOnly See
	 *                 {@link #InMemoryMedium(byte[], String, boolean, long, int)}
	...
	public InMemoryMedium(byte[] medium, String name, boolean readOnly) {
		this(medium, name, readOnly, Medium.DEFAULT_MAX_CACHE_SIZE_IN_BYTES,
			Medium.DEFAULT_MAX_READ_WRITE_BLOCK_SIZE_IN_BYTES);
	}

	/**
	 * Creates a new {@link InMemoryMedium} and allows to explicitly set all
	 * configuration properties that influence reading and writing. Note that
	 * caching is always disable for an {@link InMemoryMedium}.
	 *
	 * @param medium                       The underlying byte array, must not be
	 *                                     null
	 * @param name                         A name of the {@link InputStream} to be
	 *                                     able to identify it. Optional, i.e. null
	 *                                     may be passed
	 * @param isReadOnly                   true to make this {@link InMemoryMedium}
	 ...
	 *
	 * @param mediumBytes The bytes to set
	 */
