...
public interface MediumOffset {
   ...
   /**
    * Creates a new {@link MediumOffset} from this {@link MediumOffset} that points to N bytes behind the position of
    * this. This {@link MediumOffset} remains unchanged.
    * 
    * @param count
    *           The number of bytes to advance this {@link MediumOffset} to. May be a positive or a negative amount of
    *           bytes. The method will throw an exception if in total the absolute offset of the advanced
   ...
   /**
    * Checks whether this {@link MediumOffset} is referring to a position before the given other {@link MediumOffset}.
   ...
   /**
    * Calculates the distance from this {@link MediumOffset} to the given other {@link MediumOffset}, by subtracting the
    * absolute medium offset of this from the other {@link MediumOffset}'s offset, i.e. if other.before(this), then the
    * calculated difference will be positive, while in case of this.before(other), the calculated difference will be
    * negative.
    * 
    * This only works if both {@link MediumOffset}s refer to the same {@link Medium}.
    * 
