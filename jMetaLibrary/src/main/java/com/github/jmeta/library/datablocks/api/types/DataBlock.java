 ...
 * </ul>
 * <ul>
 * Refers to a {@link DataBlockId} to identify the {@link DataBlock} which makes the {@link DataBlock} belong to
 * exactly one {@link DataFormat}.
 * </ul>
 * <ul>
 * Has zero or exactly one parent {@link DataBlock}
 * </ul>
 * <ul>
 ...
 * 2^63-1 bytes. Such {@link DataBlock}s can only be read partly which produces incorrectly interpreted data read
 * beyond 2^63-1 bytes.
 *
...
public interface DataBlock {
   ...
   /**
    * Initially sets the parent {@link DataBlock} of this {@link DataBlock}. This method may only be called if a
    ...
    * {@link DataBlock} is not used anymore, call this method. However, after calling this method, the
    * {@link DataBlock} instance may still be used.
    */
   public void free();
}
