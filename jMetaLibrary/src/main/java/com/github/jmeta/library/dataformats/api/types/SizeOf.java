...
/**
 * {@link SizeOf} is a field function expressing that the field it refers to
 * contains the size of exactly one other data block.
 */
public class SizeOf extends AbstractFieldFunction<Long> {
	 ...
	 *                         referenced data blocks, must not be null
	 */
