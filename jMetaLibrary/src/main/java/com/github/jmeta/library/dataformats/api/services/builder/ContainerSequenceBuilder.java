...
/**
 * {@link ContainerSequenceBuilder} allows to build a sequence of container data blocks, providing methods for adding
 * concrete or generic containers with field-based or container-based payload.
 *
 * @param <C>
 *           The concrete {@link ContainerSequenceBuilder} interface derived from this interface
 */
