...
/**
 * {@link AbstractDataFormat} is the base class of all data formats supported by
 * jMeta.
 */
public abstract class AbstractDataFormat {
	 ...
	 * 
	 * @param id                 Unique identifier of the data format
	 * @param fileExtensions     File extensions supported by the data format
	 * @param mimeTypes          Mime types corresponding to the data format
	 * @param specificationLinks Links to specification documents describing the
	 *                           data format
	 * @param author             Name of the author of the data format
	 * @param revisionDate       Date of when the data format specification revision
	 *                           was created
	 */
