 ...
 * split process and delegates to an arbitrary {@link #perform(MediumOffset, int)} method implementing this
 * interface. The method {@link #perform(MediumOffset, int)} can be a implemented as lambda, or reference to a an
...
public interface MediumRangeChunkAction<T, E extends Throwable> {
    ...
    * 
    * {@link #performActionOnChunksInRange(Class, MediumOffset, int, int, MediumRangeChunkAction)} calls this method
    ...
    * {@link #perform(MediumOffset, int)} on the given last parameter. It takes the return value of this method and
    ...
    * @param action
    *           The action to perform, the method {@link #perform(MediumOffset, int)} is called on this reference,
    ...
    * {@link #performActionOnChunksInRange(Class, MediumOffset, int, int, MediumRangeChunkAction)}, but supports
