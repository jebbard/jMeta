...
/**
 * {@link FlagDescription} contains the description of a single flag. Each flag
 * has a name, a bit start position, a bit size and a description.
 */
public class FlagDescription {
	 ...
	 * @param startBitAddress The starting {@link BitAddress} of the flag.
	 * @param flagDescription A U.S. English description of the flag.
	 * @param bitSize         The length of the flag in bits.
	 * @param valueNames      The names of the values this flag can obtain. May be
	 *                        null if there are no specific names for the values. If
	 *                        non-null, the number of names must match the number of
	 *                        bits, i.e. 2^bitSize. The value names are ordered from
	...
	/**
	 * Returns the names of the values this flag may obtain. The number of names
	 * matches the bit size of the flag, i.e. 2^bitSize. The value names are ordered
	 * from lowest bit to highest.
	 *
	 * @return The names of the values this flag may obtain. The number of names
	 *         matches the bit size of the flag, i.e. 2^bitSize. The value names are
	...
	/**
	 * Returns true if this flag is a multi-bit flag, false if it consists only of a
	 * single bit.
	 *
	 * @return true if this flag is a multi-bit flag, false if it consists only of a
	 *         single bit.
	 */
