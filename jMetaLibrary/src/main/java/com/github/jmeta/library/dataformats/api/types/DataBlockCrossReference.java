 ...
 * Furthermore references can already be created and used before the referenced block is built and created and its
 * concrete id is yet unknown.
 */
public class DataBlockCrossReference {
    ...
    * 
    * @param referencedId
    *           The referenced target {@link DataBlockId}, must not be null.
    */
   ...
   /**
    * @return true if the referenced {@link DataBlockId} is already resolved, false otherwise
    */
