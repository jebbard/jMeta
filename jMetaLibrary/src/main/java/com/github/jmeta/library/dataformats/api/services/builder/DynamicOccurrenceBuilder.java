...
/**
 * {@link DynamicOccurrenceBuilder} allows to specify the number of occurrences of a data block
 */
public interface DynamicOccurrenceBuilder<C extends DataBlockDescriptionBuilder<C>> {

   /**
    * Convenience method marking this data block as optional by setting its minimum occurrences to 0 and its maximum
    * occurrences to 1.
    * 
