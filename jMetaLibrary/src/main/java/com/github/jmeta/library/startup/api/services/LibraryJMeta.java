...
/**
 * {@link LibraryJMeta} is the start interface when using the jMeta library, providing access to the overall library
...
public interface LibraryJMeta {
    ...
    */
   public static LibraryJMeta getLibrary() {

      return new StandardLibraryJMeta();
   }

   /**
    * Returns an {@link DataBlockAccessor} for accessing data blocks of a specific medium.
    * 
    * @return an {@link DataBlockAccessor} for accessing data blocks of a specific medium.
    */
   public DataBlockAccessor getDataBlockAccessor();

   /**
    * Returns an {@link DataFormatRepository} for accessing the properties of all supported data formats.
    * 
    * @return an {@link DataFormatRepository} for accessing the properties of all supported data formats.
    */
