...
/**
 * {@link InvalidMediumActionException} is thrown whenever an unknown
 * {@link MediumAction} is passed to {@link MediumStore#undo(MediumAction)}.
 */
public class InvalidMediumActionException extends JMetaRuntimeException {
	 ...
	 * 
	 * @param invalidAction the invalid {@link MediumAction} that lead to the
	 *                      exception.
	 */
