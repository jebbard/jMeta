...
/**
 * {@link FieldSequenceBuilder} allows to build a sequence of ordered field data
 * blocks.
 *
 * @param <C> The concrete {@link FieldSequenceBuilder} interface derived from
 *            this interface
 */
public interface FieldSequenceBuilder<C extends FieldSequenceBuilder<C>> extends DataBlockDescriptionBuilder<C> {
	...
	/**
	 * Allows to remove a field already added to another field sequence which has
	 * been cloned before.
	 * 
	 * @param fieldReference The field reference pointing to the field to remove,
	 *                       must not be null and must indeed refer to a child field
	 *                       previously added
