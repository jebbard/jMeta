...
public class Flags {
   ...
   public short asShort() {
      Reject.ifFalse(getSpecification().getByteLength() >= SHORT_BYTE_LENGTH, "getSpecification().getByteLength() >= SHORT_BYTE_LENGTH");
    ...
    */
   public int asInt() {
      Reject.ifFalse(getSpecification().getByteLength() >= INT_BYTE_LENGTH, "getSpecification().getByteLength() >= INT_BYTE_LENGTH");
    ...
    */
   public long asLong() {
      Reject.ifFalse(getSpecification().getByteLength() >= LONG_BYTE_LENGTH, "getSpecification().getByteLength() >= LONG_BYTE_LENGTH");
