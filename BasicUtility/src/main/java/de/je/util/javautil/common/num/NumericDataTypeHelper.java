...
/**
 * {@link NumericDataTypeHelper} provides helper functionality for the built-in numeric primitive types byte, short, int
 * and long.
 */
public class NumericDataTypeHelper {
   ...
   /**
    * Creates a new {@link NumericDataTypeHelper}. Private constructor because this is a static helper class only.
    */
   private NumericDataTypeHelper() {
