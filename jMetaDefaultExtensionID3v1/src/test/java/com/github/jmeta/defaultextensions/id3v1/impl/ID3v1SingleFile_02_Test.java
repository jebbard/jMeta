 ...
 */
public class ID3v1SingleFile_02_Test extends AbstractLowLevelAPITest {
	...
	public ID3v1SingleFile_02_Test() {
		super(ID3v1SingleFile_02_Test.THE_FILE, ID3v1SingleFile_02_Test.THE_CSV_FILE, new Integer[] { 4 });
	}
}
