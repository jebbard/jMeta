 ...
 */
public class ID3v1SingleFile_03_Test extends AbstractLowLevelAPITest {
	...
	public ID3v1SingleFile_03_Test() {
		super(ID3v1SingleFile_03_Test.THE_FILE, ID3v1SingleFile_03_Test.THE_CSV_FILE, new Integer[] { 4 });
	}
}
