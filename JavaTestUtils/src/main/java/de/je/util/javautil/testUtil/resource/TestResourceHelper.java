package de.je.util.javautil.testUtil.resource;
...
public class TestResourceHelper {
   ...
   public static Path resourceToFile(Class<?> clazz, String resourceName) {
      TestReject.ifNull(resourceName, "resourceName");
      TestReject.ifNull(clazz, "clazz");
   ...
   /**
    * Tries to convert a given test resource into an {@link InputStream}. The test resource must be located relative to
    * a given {@link Class} instance. This requires the resource be bundled with the given .class-File.
    * 
    * @param clazz
    *           The {@link Class} instance.
    * @param resourceName
